{
    ...
    "advancements.adventure.lightning_rod_with_villager_no_fire.description": "Bescherm een dorpeling tegen een ongewenste schok zonder een brand te stichten",
    ...
    "advancements.adventure.play_jukebox_in_meadows.description": "Breng de bilk tot leven met het geluid van muziek uit een jukebox",
    ...
    "advancements.adventure.sleep_in_bed.description": "Slaap in een bed om uw respawnpunt te veranderen",
    ...
    "advancements.adventure.throw_trident.description": "Gooi een drietand ergens naartoe. Opmerking: Uw enige wapen weggooien is een slecht idee.",
    ...
    "advancements.adventure.trade_at_world_height.description": "Handel met een dorpsbewoner op het bouwlimiet",
    ...
    "advancements.husbandry.complete_catalogue.description": "Tem alle varianten van katten!",
    ...
    "advancements.story.iron_tools.description": "Upgrade uw houweel",
    ...
    "advancements.story.mine_stone.description": "Verkrijg steen met uw nieuwe houweel",
    ...
    "argument.pos2d.incomplete": "Niet compleet (twee co\u00f6rdinaten verwacht)",
    ...
    "commands.banip.info": "Het verbannen heeft invloed op %s speler(s): %s",
    ...
    "commands.banlist.list": "Er zijn %s speler(s) verbannen:",
    ...
    "commands.clear.success.multiple": "%s voorwerp(en) van %s spelers verwijderd",
    "commands.clear.success.single": "%s voorwerp(en) van %s verwijderd",
    ...
    "commands.execute.blocks.toobig": "Teveel blokken in het gespecificeerde gebied (maximaal %s, %s opgegeven)",
    ...
    "commands.fill.toobig": "Teveel blokken in het gespecificeerde gebied (maximaal %s, %s opgegeven)",
    ...
    "commands.locate.failed": "Kan structuur met type '%s' niet in de buurt vinden",
    "commands.locate.invalid": "Structuur met type '%s' bestaat niet",
    "commands.locate.success": "Dichtste %s bevindt zich op %s (%s blokken afstand)",
    "commands.locatebiome.invalid": "Er is geen klimaatsoort van het type \"%s\"",
    "commands.locatebiome.notFound": "Vinden van klimaatsoort \"%s\" binnen een redelijke afstand mislukt",
    "commands.locatebiome.success": "Dichtste %s bevindt zich op %s (%s blokken afstand)",
    ...
    "commands.placefeature.invalid": "Kenmerk met type '%s' bestaat niet",
    ...
    "commands.spreadplayers.failed.entities": "Kan %s entiteit(en) niet verspreiden rond %s, %s (teveel entiteiten voor de ruimte - probeer een verspreiding van maximaal %s)",
    "commands.spreadplayers.failed.invalid.height": "Waarde %s voor maxHeight is ongeldig, hoger dan wereldminimum %s verwacht.",
    "commands.spreadplayers.failed.teams": "Kan %s team(s) niet verspreiden rond %s, %s (teveel entiteiten voor de ruimte - probeer een verspreiding van maximaal %s)",
    "commands.spreadplayers.success.entities": "%s spelers verspreid over %s, %s, met een gemiddelde afstand van %s blokken tussen teams",
    ...
    "commands.whitelist.list": "Er staan %s speler(s) op de gastenlijst: %s",
    ...
    "commands.worldborder.set.immediate": "Wereldgrens is ingesteld op %s blokken breed",
    ...
    "enchantment.unknown": "Onbekende betovering: %s",
    ...
    "generator.single_biome_surface": "Enkel klimaat",
    ...
    "selectServer.delete": "Verwijder",
    "selectServer.deleteButton": "Verwijder",
    "selectServer.deleteQuestion": "Ben je zeker dat je deze server wilt verwijderen?",
    "selectServer.deleteWarning": "'%s' zal verloren zijn voor altijd! (En dat is lang!)",
    ...
    "selectWorld.import_worldgen_settings.deprecated.question": "Sommige gebruikte functies zijn verouderd en zullen in de toekomst stoppen met functioneren. Wilt u doorgaan?",
    "selectWorld.import_worldgen_settings.deprecated.title": "Waarschuwing! Deze instellingen gebruiken verouderde functies",
    "selectWorld.import_worldgen_settings.experimental.question": "Deze instellingen zijn experimenteel en kunnen op een gegeven moment stoppen met functioneren. Wilt u doorgaan?",
    ...
    "subtitles.entity.parrot.imitate.piglin_brute": "Papegaai snuift machtig",
    ...
    "title.multiplayer.disabled": "Samen spelen is uitgeschakeld. Controleer uw Microsoft account instellingen.",
