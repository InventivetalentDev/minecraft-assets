{
    ...
    "advancements.adventure.honey_block_slide.description": "Jump against a Honey Block to slow down your fall",
    ...
    "block.minecraft.oxeye_daisy": "Moon Daisy",
    ...
    "block.minecraft.spawn.not_valid": "You have no home bed nor charged respawn anchor, or it was obstructed",
    ...
    "commands.worldborder.center.failed": "Nothing changed. The world border is already centred there",
    ...
    "death.attack.message_too_long": "Message was too long to deliver fully. Sorry! Here's the stripped version: %s",
    ...
    "death.attack.onFire.player": "%1$s was burnt to a crisp while fighting %2$s",
    ...
    "item.minecraft.chainmail_chestplate": "Mail Chestplate",
    "item.minecraft.chainmail_helmet": "Mail Helmet",
    "item.minecraft.chainmail_leggings": "Mail Leggings",
    ...
    "key.advancements": "Advancements Screen",
    ...
    "narration.selection.usage": "Press up or down keys to move to another entry",
    "narration.slider.usage.focused": "Press left or right keys to change value",
    ...
    "narrator.screen.usage": "Use mouse cursor or Tab key to select element",
    ...
    "subtitles.entity.piglin.converted_to_zombified": "Piglin converted to Zombified Piglin",
    ...
    "subtitles.entity.zombie.destroy_egg": "Turtle Egg stomped on",
