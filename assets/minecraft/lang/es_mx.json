{
    ...
    "advancements.adventure.kill_a_mob.description": "Mata una criatura hostil",
    ...
    "advancements.adventure.spyglass_at_dragon.description": "Mira al Ender Dragon a trav\u00e9s de un catalejo",
    ...
    "advancements.adventure.trade_at_world_height.description": "Intercambia con un aldeano en el l\u00edmite de altura",
    ...
    "advancements.husbandry.make_a_sign_glow.description": "Haz que el texto del letrero brille",
    ...
    "advancements.nether.ride_strider_in_overworld_lava.description": "Monta un Strider y da un laaaargo paseo sobre lava en la superficie",
    ...
    "argument.entity.toomany": "S\u00f3lo se permite una entidad, pero el selector utilizado permite m\u00e1s de una",
    ...
    "argument.player.entities": "Este comando s\u00f3lo afecta a jugadores, pero el selector utilizado incluye entidades",
    "argument.player.toomany": "S\u00f3lo se permite un jugador, pero el selector utilizado permite m\u00e1s de uno",
    ...
    "arguments.objective.readonly": "El objetivo \"%s\" de la tabla de puntaje es s\u00f3lo de lectura",
    ...
    "biome.minecraft.old_growth_pine_taiga": "Taiga de pino ancestral",
    "biome.minecraft.old_growth_spruce_taiga": "Taiga de abeto ancestral",
    ...
    "biome.minecraft.windswept_forest": "Bosque batido",
    "biome.minecraft.windswept_gravelly_hills": "Monta\u00f1as pedregosas abatidas",
    "biome.minecraft.windswept_hills": "Colinas abatidas",
    "biome.minecraft.windswept_savanna": "Sabana ventiscosa",
    "biome.minecraft.wooded_badlands": "Badlands boscosas",
    ...
    "chat.disabled.profile": "El chat est\u00e1 desactivado en las opciones de tu cuenta. No se puede enviar el mensaje",
    "chat.editBox": "chat",
    ...
    "commands.data.get.invalid": "No se pudo obtener %s, s\u00f3lo se permiten tags num\u00e9ricos",
    ...
    "commands.debug.alreadyRunning": "El an\u00e1lisis de ticks ya hab\u00eda iniciado",
    "commands.debug.function.noRecursion": "No se puede rastrear dentro de una funci\u00f3n",
    "commands.debug.function.success.multiple": "%s comandos fueron rastreados de %s funciones al archivo resultante %s",
    "commands.debug.function.success.single": "Se rastrearon %s comandos desde la funci\u00f3n \"%s\" al archivo resultante %s",
    "commands.debug.function.traceFailed": "Error al rastrear funci\u00f3n",
    "commands.debug.notRunning": "El an\u00e1lisis de ticks no hab\u00eda iniciado",
    "commands.debug.started": "An\u00e1lisis de ticks iniciado",
    "commands.debug.stopped": "An\u00e1lisis de ticks detenido tras %s segundos y %s ticks (%s ticks por segundo)",
    ...
    "commands.locate.failed": "No se pudo encontrar la estructura \"%s\" m\u00e1s cercana",
    "commands.locate.invalid": "La estructura \"%s\" no existe",
    ...
    "commands.op.failed": "Nada cambi\u00f3: el jugador ya era operador",
    ...
    "commands.perf.stopped": "An\u00e1lisis de rendimiento detenido tras %s segundos y %s ticks (%s ticks por segundo)",
    ...
    "commands.setidletimeout.success": "Tiempo m\u00e1ximo de inactividad de jugadores cambiado a %s minutos",
    ...
    "commands.spreadplayers.failed.invalid.height": "Altura m\u00e1xima inv\u00e1lida %s; se requiere un valor mayor al m\u00ednimo %s del mundo",
    ...
    "commands.tag.add.success.multiple": "Tag \"%s\" agregada a %s entidades",
    "commands.tag.add.success.single": "Tag \"%s\" agregada a %s",
    "commands.tag.list.multiple.empty": "No hay tags en las %s entidades",
    "commands.tag.list.multiple.success": "Las %s entidades tienen un total de %s tags: %s",
    "commands.tag.list.single.empty": "%s no tiene tags",
    "commands.tag.list.single.success": "%s tiene %s tags: %s",
    "commands.tag.remove.failed": "El objetivo no tiene este tag",
    "commands.tag.remove.success.multiple": "Tag \"%s\" eliminada de %s entidades",
    "commands.tag.remove.success.single": "Tag \"%s\" eliminada de %s",
    ...
    "commands.worldborder.set.immediate": "Borde del mundo establecido en %s bloques de largo",
    ...
    "compliance.playtime.message": "El juego excesivo puede interferir con tu vida cotidiana",
    ...
    "dataPack.title": "Seleccionar packs de datos",
    ...
    "dataPack.validation.working": "Validando packs de datos seleccionados...",
    "dataPack.vanilla.description": "Los datos por defecto de Minecraft",
    "datapackFailure.safeMode": "Modo seguro",
    "datapackFailure.title": "No se pudo cargar el mundo porque hay errores en los packs de datos seleccionados.\nPuedes intentar cargarlo \u00fanicamente con el pack de datos vanilla (\"modo seguro\") o volver al men\u00fa principal y buscar una soluci\u00f3n manualmente.",
    ...
    "death.attack.fireball": "%1$s se quem\u00f3 por una bola de fuego de %2$s",
    ...
    "death.attack.freeze": "%1$s muri\u00f3 congelado",
    "death.attack.freeze.player": "%1$s fue congelado por %2$s",
    ...
    "death.attack.hotFloor.player": "%1$s camin\u00f3 por una zona peligrosa por culpa de un(a) %2$s",
    ...
    "death.attack.magic.player": "%1$s muri\u00f3 por arte de magia mientras escapaba de %2$s",
    ...
    "debug.cycle_renderdistance.help": "F3 + F = Aumentar distancia de renderizado (May\u00fas para reducirla)",
    ...
    "debug.reload_resourcepacks.message": "Packs de recursos recargados",
    ...
    "gamerule.freezeDamage": "Da\u00f1os por congelaci\u00f3n",
    ...
    "multiplayer.applyingPack": "Aplicando pack de recursos",
    ...
    "multiplayer.requiredTexturePrompt.disconnect": "Para conectarte debes aceptar el pack de recursos del servidor",
    "multiplayer.requiredTexturePrompt.line1": "El servidor requiere el uso de su propio pack de recursos.",
    ...
    "multiplayer.texturePrompt.failure.line1": "No se pudo aplicar el pack de recursos del servidor",
    ...
    "multiplayer.texturePrompt.line1": "El servidor recomienda usar su propio pack de recursos.",
    ...
    "narration.edit_box": "Casilla de edici\u00f3n: %s",
    ...
    "options.allowServerListing.tooltip": "Los servidores pueden mostrar nombres de algunos usuarios conectados como parte de su estado p\u00fablico.\nAl desactivar esta opci\u00f3n, tu nombre no se mostrar\u00e1 en dichas listas.",
    ...
    "options.fovEffectScale.tooltip": "Modifica qu\u00e9 tanto cambia el FOV (campo visual) al tener el efecto velocidad.",
    "options.framerate": "%s",
    ...
    "options.prioritizeChunkUpdates.byPlayer.tooltip": "Algunas acciones dentro de un chunk har\u00e1n que el chunk se recompile inmediatamente. Esto tambi\u00e9n incluye colocar y destruir bloques.",
    ...
    "pack.dropConfirm": "\u00bfQuieres agregar estos packs a Minecraft?",
    "pack.dropInfo": "Arrastra archivos a esta ventana para agregar packs",
    "pack.folderInfo": "(Coloca archivos de packs aqu\u00ed)",
    ...
    "pack.incompatible.confirm.title": "\u00bfSeguro que quieres cargar este pack?",
    ...
    "selectWorld.import_worldgen_settings.deprecated.title": "\u00a1Advertencia! Estas opciones est\u00e1n usando caracter\u00edsticas obsoletas.",
    ...
    "subtitles.block.big_dripleaf.tilt_down": "Plantaforma se ladea hacia abajo",
    ...
    "subtitles.block.door.toggle": "Puerta resuena",
    ...
    "subtitles.block.respawn_anchor.deplete": "Nexo de reaparici\u00f3n necesita carga",
    ...
    "subtitles.block.trapdoor.toggle": "Trampilla resuena",
    ...
    "subtitles.entity.evoker.cast_spell": "Invocador lanza hechizo",
    "subtitles.entity.evoker.celebrate": "Invocador festejando",
    "subtitles.entity.evoker.death": "Invocador muerto",
    ...
    "subtitles.entity.fox.screech": "Zorro aullando",
    ...
    "subtitles.entity.glow_item_frame.remove_item": "Objeto quitado de un marco brillante",
    ...
    "subtitles.entity.item_frame.remove_item": "Objeto quitado de un marco",
    ...
    "subtitles.entity.mooshroom.convert": "Vaca mooshroom mutando",
    "subtitles.entity.mooshroom.eat": "Vaca mooshroom comiendo",
    "subtitles.entity.mooshroom.milk": "Vaca mooshroom orde\u00f1ada",
    "subtitles.entity.mooshroom.suspicious_milk": "Vaca mooshroom orde\u00f1ada con recelo",
    ...
    "subtitles.entity.parrot.imitate.elder_guardian": "Loro imitando a un guardi\u00e1n anciano",
    ...
    "subtitles.entity.parrot.imitate.evoker": "Loro imitando a un invocador",
    ...
    "subtitles.entity.player.death": "Jugador muerto",
    ...
    "subtitles.entity.player.levelup": "Jugador subiendo de nivel",
    ...
    "subtitles.entity.turtle.egg_crack": "Huevo de toruga se resquebraja",
    ...
    "subtitles.item.glow_ink_sac.use": "Saco de tinta luminosa manchando",
    ...
    "title.32bit.deprecation.realms": "Minecraft pr\u00f3ximamente requerir\u00e1 un sistema de 64 bits, lo que te impedir\u00e1 jugar o utilizar Realms en este dispositivo. Tendr\u00e1s que cancelar manualmente cualquier suscripci\u00f3n a Realms.",
