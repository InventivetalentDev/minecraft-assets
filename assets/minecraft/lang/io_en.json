{
    ...
    "advancements.adventure.hero_of_the_village.title": "Tutelanto di vilajano",
    ...
    "advancements.adventure.ol_betsy.description": "Lansar arbalesto",
    ...
    "advancements.adventure.throw_trident.description": "Jetar tridento vers ulo.\nNotez: Jetar vua armo sula ne esas bona ideo.",
    ...
    "advancements.adventure.two_birds_one_arrow.description": "Ocidar du fantomi kun flecho penetranta",
    ...
    "advancements.end.dragon_breath.description": "Kolektar respiro di drako dans vitra botelo",
    ...
    "advancements.husbandry.complete_catalogue.description": "Amansar singla varianti di kato!",
    ...
    "advancements.husbandry.safely_harvest_honey.description": "Uzez kampfairo por kolektar mielo de abeluyo uzanta botelo sen iritas la abeli",
    "advancements.husbandry.safely_harvest_honey.title": "Nia mielo esas vua mielo",
    "advancements.husbandry.silk_touch_nest.description": "Movez albenesto, kontenas 3 abeli, uzanta silktusho",
    "advancements.husbandry.silk_touch_nest.title": "Spoliabelo plenjornala",
    "advancements.husbandry.tactical_fishing.description": "Kaptar fisho... sen peskobastono!",
    ...
    "advancements.story.lava_bucket.description": "Plenigar sitelo di lavao",
    ...
    "advancements.story.smelt_iron.description": "Fuzar fera lingoto",
    ...
    "argument.entity.options.gamemode.description": "Luderi kun ludo-modo",
    ...
    "argument.pos2d.incomplete": "Nekompleta (expektis 2 koordinati)",
    ...
    "attribute.name.generic.luck": "Chanco",
    "attribute.name.generic.max_health": "Maxima saneso",
    "attribute.name.generic.movement_speed": "Rapideso",
    ...
    "biome.minecraft.snowy_taiga": "Taigo nivala",
    "biome.minecraft.sunflower_plains": "Plani di sunflori",
    "biome.minecraft.swamp": "Marsho",
    "biome.minecraft.taiga": "Taigo",
    "biome.minecraft.the_end": "La End",
    "biome.minecraft.the_void": "La vakuo",
    ...
    "color.minecraft.cyan": "Ciana",
    "color.minecraft.gray": "Griza",
    "color.minecraft.green": "Verda",
    "color.minecraft.light_blue": "Klarablua",
    "color.minecraft.light_gray": "Klaragriza",
    "color.minecraft.lime": "Limetea",
    "color.minecraft.magenta": "Klarpurpura",
    "color.minecraft.orange": "Oranjea",
    "color.minecraft.pink": "Rozea",
    "color.minecraft.purple": "Purpura",
    "color.minecraft.red": "Reda",
    ...
    "commands.banip.info": "Ica blokuso afektacas %s luderi: %s",
    ...
    "commands.banlist.list": "Esas %s blokusi:",
    ...
    "commands.bossbar.get.players.some": "Personaligita chefostango %s havas %s luderi prezente enrete: %s",
    ...
    "commands.bossbar.list.bars.some": "Esas %s personaligita chefostangi aktive: %s",
    ...
    "commands.bossbar.set.players.success.some": "Personaligita chefostango %s nun havas %s ludanti: %s",
    ...
    "commands.clear.success.multiple": "Forigita %s objekti de %s luderi",
    "commands.clear.success.single": "Forigita %s objekti de ludero %s",
    "commands.clear.test.multiple": "Trovita %s objekti korespondanta ye %s luderi",
    "commands.clear.test.single": "Trovita %s objekti korespondanta ye ludero %s",
    "commands.clone.failed": "Nula bloki esis kopiis",
    "commands.clone.overlap": "Le fonto e destino ne povas imbrikar",
    "commands.clone.success": "Sucesanta klonita %s bloki",
    ...
    "commands.datapack.list.available.success": "Existas %s donaji-paki disponebla: %s",
    "commands.datapack.list.enabled.none": "Existas nula donaji-paki disponebla",
    "commands.datapack.list.enabled.success": "Existas %s donaji-paki disponebla: %s",
    ...
    "commands.enchant.failed.entity": "%s ne esas ento valida por ica komando",
    ...
    "commands.execute.blocks.toobig": "Tro multa bloki en l'areo specigata (maximo %s, specigata %s)",
    ...
    "commands.fill.success": "Sucesanta plenigita %s bloki",
    "commands.fill.toobig": "Tro multa bloki en l'areo specigata (maximo %s, specigata %s)",
    ...
    "commands.function.success.multiple": "Exekutita %s imperi de %s funcioni",
    "commands.function.success.single": "Exekutita %s imperi de funciono '%s'",
    ...
    "commands.locate.success": "La maxim proxima %s esas ye %s (%s bloki fore)",
    "commands.locatebiome.success": "La maxim proxima %s esas ye %s (%s bloki fore)",
    ...
    "commands.schedule.cleared.success": "Efacis %s preparas kun ID %s",
    "commands.schedule.created.function": "Preparis functiono '%s' en %s tiki a ludtempo %s",
    ...
    "commands.scoreboard.objectives.list.success": "Esas %s objektali: %s",
    ...
    "commands.scoreboard.players.list.entity.success": "%s havas %s punti:",
    "commands.scoreboard.players.list.success": "Esas %s detektita enti: %s",
    "commands.scoreboard.players.operation.success.multiple": "Aktualigita %s por %s enti",
    "commands.scoreboard.players.operation.success.single": "Pozita %s por %s a(d) %s",
    ...
    "commands.setidletimeout.success": "La ludera neaganta tempo esas nun %s minuti",
    ...
    "commands.spreadplayers.failed.entities": "Ne povis dissendar %s enti cirkum %s, %s (tro multa enti por spaco - probez uzar dissendo di admaxime %s)",
    "commands.spreadplayers.failed.teams": "Ne povis dissendar %s esquadi cirkum %s, %s (tro multa enti por spaco - probez uzar dissendo di admaxime %s)",
    "commands.spreadplayers.success.entities": "Spredar %s ludari atour la posito %s, %s ye averaga distanco de %s blocki inter",
    "commands.spreadplayers.success.teams": "Spredar %s trupi atour la posito %s, %s ye averaga distanco de %s blocki inter",
    ...
    "commands.team.empty.success": "Forigita %s membri de esquado %s",
    ...
    "commands.team.list.members.success": "Esquado %s havas %s membri: %s",
    "commands.team.list.teams.empty": "Ne esas esquadi",
    "commands.team.list.teams.success": "Esas %s esquadi: %s",
    ...
    "commands.whitelist.list": "Esas %s luderi en la listo blanka: %s",
    ...
    "commands.worldborder.damage.buffer.success": "La domago bufero de la aliro de mondo estas fixis a %s blocki",
    "commands.worldborder.get": "La mondo-bordo esas prezente %s bloki larja",
    ...
    "commands.worldborder.set.immediate": "Pozita la bordo di la mondo a %s bloki larja",
    "commands.worldborder.set.shrink": "Diminutanta la mondo-bordo a %s bloki larja en %s sekundi",
    "commands.worldborder.warning.distance.failed": "Nulo chanjis. La averto di bordo ja esas ita disto",
    "commands.worldborder.warning.distance.success": "Pozar la averto-disto di mondo-frontiero a %s bloki",
    "commands.worldborder.warning.time.failed": "Nulo chanjis. La averto di bordo ja esas ita longeso di tempo",
    "commands.worldborder.warning.time.success": "La averto tempo de la aliro de mondo estas fixis a %s sekondi",
    ...
    "container.blast_furnace": "Fornego",
    "container.brewing": "Brasadostativo",
    "container.cartography_table": "Tablo di kartografio",
    "container.chest": "Kofro",
    "container.chestDouble": "Kofrego",
    "container.crafting": "Fabrikado",
    "container.creative": "Objektselekto",
    "container.dispenser": "Lansilo",
    "container.dropper": "Distributilo",
    ...
    "container.enderchest": "Kofro di Ender",
    "container.furnace": "Furnazo",
    ...
    "createWorld.customize.custom.presets": "Predefini",
    ...
    "createWorld.customize.preset.bottomless_pit": "Foso senfunda",
    "createWorld.customize.preset.classic_flat": "Klasika",
    "createWorld.customize.preset.desert": "Dezerto",
    "createWorld.customize.preset.overworld": "Superamondo",
    "createWorld.customize.preset.redstone_ready": "Pronta por Redstoneo",
    "createWorld.customize.preset.snowy_kingdom": "Rejio nivala",
    "createWorld.customize.preset.the_void": "La vakuajo",
    "createWorld.customize.preset.tunnelers_dream": "Revo di ministi",
    "createWorld.customize.preset.water_world": "Mondo aquala",
    ...
    "datapackFailure.title": "Erori en datumpaki selektata prezente preventis la mondo charjar. Vu povas eforcar charjar ol kun sola datumpako vanila (\"modo sekura\"), o rivenar a titulskreno e reparar ol manuale.",
    ...
    "death.attack.dragonBreath": "%1$s rostesis en respiro di drako",
    "death.attack.dragonBreath.player": "%1$s rostesis en respiro di drako per %2$s",
    ...
    "death.attack.hotFloor.player": "%1$s marchis aden danjerareo pro %2$s",
    ...
    "death.attack.message_too_long": "Desfortunoze, mesajo esis tro longa por livrar plene. Pardonez! Hike esas versiono reduktita: %s",
    ...
    "death.attack.player": "%1$s ocidesis per %2$s",
    "death.attack.player.item": "%1$s ocidesis per %2$s kun %3$s",
    ...
    "deathScreen.titleScreen": "Titulskreno",
    ...
    "debug.cycle_renderdistance.message": "Disto di charjo: %s",
    ...
    "disconnect.quitting": "Abandonigo",
    ...
    "effect.effectNotFound": "Efekto nekonocata: %s",
    ...
    "effect.minecraft.wither": "Withereso",
    ...
    "enchantment.unknown": "Charmivo nekonocata: %s",
    ...
    "entity.minecraft.firework_rocket": "Pirotekno",
    ...
    "entity.minecraft.spawner_minecart": "Minvagono kun generatoro",
    ...
    "entity.notFound": "Ento nekonocata: %s",
    ...
    "gamerule.category.chat": "Konverso",
    "gamerule.category.misc": "Diversa",
    "gamerule.category.mobs": "Kreaji",
    "gamerule.category.player": "Ludanto",
    "generator.amplified": "AMPLIGITA",
    "generator.amplified.info": "Avertez: Nur por amuzo! Bezonas forta komputero.",
    "generator.custom": "Personaligita",
    "generator.customized": "Personalizita",
    "generator.debug_all_block_states": "Modo di debugar",
    "generator.default": "Originala",
    "generator.flat": "Superplana",
    "generator.large_biomes": "Granda biomi",
    "generator.single_biome_caves": "Kaverni",
    "generator.single_biome_floating_islands": "Insuli flotacanta",
    "generator.single_biome_surface": "Biomo sola",
    "gui.advancements": "Avancadi",
    "gui.all": "Omni",
    "gui.back": "Rivenar",
    "gui.cancel": "Abrogar",
    "gui.done": "Facita",
    ...
    "gui.socialInteractions.status_blocked": "Barata",
    "gui.socialInteractions.status_blocked_offline": "Barata - Eklinea",
    "gui.socialInteractions.status_hidden": "Nevidebla",
    ...
    "gui.socialInteractions.tooltip.hide": "Celar mesaji de %s en konverso",
    "gui.socialInteractions.tooltip.show": "Montrar mesaji de %s en konverso",
    ...
    "item.minecraft.brewing_stand": "Brasadostativo",
    ...
    "item.minecraft.firework_star.custom_color": "Personaligita",
    ...
    "item.minecraft.flower_banner_pattern": "Shablono di banero",
    ...
    "item.minecraft.globe_banner_pattern": "Shablono di banero",
    ...
    "item.minecraft.mojang_banner_pattern": "Shablono di banero",
    ...
    "item.minecraft.piglin_banner_pattern": "Shablono di banero",
    ...
    "item.minecraft.skull_banner_pattern": "Shablono di banero",
    ...
    "item.minecraft.tipped_arrow.effect.awkward": "Efektflecho",
    ...
    "item.minecraft.tipped_arrow.effect.mundane": "Efektflecho",
    ...
    "item.minecraft.tipped_arrow.effect.thick": "Efektflecho",
    ...
    "itemGroup.brewing": "Pocioni",
    "itemGroup.buildingBlocks": "Bloki di konstrukto",
    "itemGroup.combat": "Kombato",
    "itemGroup.decorations": "Bloki di dekoruro",
    "itemGroup.food": "Manjaji",
    "itemGroup.hotbar": "Bendi konservita",
    "itemGroup.inventory": "Inventario di transvivo",
    "itemGroup.materials": "Materii",
    "itemGroup.misc": "Diversa",
    "itemGroup.redstone": "Redstoneo",
    "itemGroup.search": "Serchar",
    "itemGroup.tools": "Utensili",
    "itemGroup.transportation": "Transportado",
    ...
    "key.categories.creative": "Modo kreiva",
    ...
    "key.categories.multiplayer": "Plura ludanti",
    ...
    "key.keyboard.unknown": "Ne bindata",
    ...
    "multiplayer.disconnect.outdated_client": "Kliento nekonciliebla! Voluntez uzar %s",
    "multiplayer.disconnect.outdated_server": "Kliento nekonciliebla! Voluntez uzar %s",
    ...
    "optimizeWorld.stage.finished": "Kompletigas...",
    "optimizeWorld.stage.upgrading": "Amelioras omna chunki...",
    "optimizeWorld.title": "Maxbonigas mondo '%s'",
    "options.accessibility.text_background": "Dopaframo di texto",
    "options.accessibility.text_background.chat": "Konverso",
    ...
    "options.fovEffectScale.tooltip": "Kontrolas quante la agro di vidado povas chanjar kun efekti di rapideso.",
    ...
    "options.graphics.warning.accept": "Avanirar sen eniro",
    ...
    "options.realmsNotifications": "Notifikuri di Realms",
    ...
    "selectServer.delete": "Efacar",
    "selectServer.deleteButton": "Efacar",
    "selectServer.deleteQuestion": "Ka vu certe volas efacar ica servero?",
    "selectServer.deleteWarning": "'%s' esos perdata por sempre! (Longa tempo!)",
    "selectServer.direct": "Direta konekto",
    "selectServer.edit": "Modifikar",
    ...
    "selectWorld.import_worldgen_settings.deprecated.question": "Ula traiti uzata esas deskonsilata e malfuncionos future. Ka vu volas procedar?",
    "selectWorld.import_worldgen_settings.deprecated.title": "Avertez! Ica ajusti uzas traiti deskoncilata",
    "selectWorld.import_worldgen_settings.experimental.question": "Ica ajusti esas experimentala e povas malfuncionar future. Ka vu volas procedar?",
    "selectWorld.import_worldgen_settings.experimental.title": "Avertez! Ica ajusti uzas traiti experimentala",
    ...
    "selectWorld.mapFeatures.info": "Vilaji, subtera karceri, etc.",
    ...
    "selectWorld.recreate.customized.title": "Mondi personalizita ne plu suportesas",
    "selectWorld.recreate.error.text": "Ulo faliis dum ke esforcas rikrear mondo.",
    "selectWorld.recreate.error.title": "Eroro eventis!",
    ...
    "spectatorMenu.next_page": "Sequanta pagino",
    "spectatorMenu.previous_page": "Antea pagino",
    ...
    "stat.minecraft.ring_bell": "Kloshi sonigesis",
    ...
    "structure_block.detect_size": "Detektar grandeso e posteno di strukturo:",
    ...
    "structure_block.include_entities": "Inkluzar enti:",
    ...
    "structure_block.mode.save": "Konservar",
    ...
    "subtitles.entity.bee.loop": "Arbelo zumas",
    ...
    "subtitles.entity.drowned.ambient_water": "Dronito gluglas",
    ...
    "subtitles.entity.generic.big_fall": "Ulo falis",
    ...
    "subtitles.entity.horse.angry": "Kavalo bramas",
    ...
    "subtitles.entity.leash_knot.break": "Ligilo ruptas",
    "subtitles.entity.leash_knot.place": "Ligilo fixigesas",
    ...
    "subtitles.entity.parrot.imitate.elder_guardian": "Papagayo alostrokas",
    ...
    "subtitles.entity.parrot.imitate.guardian": "Papagayo jemas",
    "subtitles.entity.parrot.imitate.husk": "Papagayo jemas",
    "subtitles.entity.parrot.imitate.illusioner": "Papagayo murmuras",
    "subtitles.entity.parrot.imitate.magma_cube": "Papagayo splastas",
    "subtitles.entity.parrot.imitate.phantom": "Papagayo skrias",
    "subtitles.entity.parrot.imitate.pillager": "Papagayo murmuras",
    "subtitles.entity.parrot.imitate.ravager": "Papagayo grunas",
    "subtitles.entity.parrot.imitate.shulker": "Papagayo guatas",
    "subtitles.entity.parrot.imitate.silverfish": "Papagayo sisas",
    "subtitles.entity.parrot.imitate.skeleton": "Papagayo kliktigas",
    "subtitles.entity.parrot.imitate.slime": "Papagayo splastas",
    "subtitles.entity.parrot.imitate.spider": "Papagayo sisas",
    "subtitles.entity.parrot.imitate.stray": "Papagayo kliktigas",
    ...
    "subtitles.entity.parrot.imitate.wither_skeleton": "Papagayo kliktigas",
    "subtitles.entity.parrot.imitate.zombie": "Papagayo jemas",
    "subtitles.entity.parrot.imitate.zombie_villager": "Papagayo jemas",
    ...
    "subtitles.entity.pig.saddle": "Selo equipesas",
    ...
    "subtitles.entity.shulker.close": "Shulkero klozas",
    "subtitles.entity.shulker.death": "Shulkero mortas",
    "subtitles.entity.shulker.hurt": "Shulkero doloras",
    "subtitles.entity.shulker.open": "Shulkero apertas",
    ...
    "subtitles.item.crossbow.hit": "Flecho frapas",
    ...
    "subtitles.item.nether_wart.plant": "Rekontajo plantacesas",
    ...
    "team.collision.never": "Nul-tempe",
    ...
    "title.32bit.deprecation.realms.check": "Ne montrar ica skreno itere",
    "title.multiplayer.disabled": "Plura-ludanti esas desabligata. Voluntez chekar la ajusti pri vua konto di Microsoft.",
    "title.multiplayer.lan": "Plura ludanti (LAN)",
    "title.multiplayer.realms": "Plura lundanti (Realms)",
    "title.singleplayer": "Un ludanto",
