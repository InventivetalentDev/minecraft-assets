{
    ...
    "advMode.allEntities": "Gebruik '@e' voor alle entiteiten",
    ...
    "advMode.mode.sequence": "Gekoppeld",
    "advMode.mode.unconditional": "Onvoorwaardelijk",
    "advMode.nearestPlayer": "Gebruik '@p' voor de dichtstbijzijnde speler",
    "advMode.notAllowed": "Je moet een gepromoveerde speler in de creatieve modus zijn",
    "advMode.notEnabled": "Opdrachtblokken zijn niet ingeschakeld op deze server",
    "advMode.previousOutput": "Vorige uitvoer",
    "advMode.randomPlayer": "Gebruik '@r' voor een willekeurige speler",
    "advMode.self": "Gebruik '@s' voor het uitvoerende entiteit",
    ...
    "advancements.adventure.arbalistic.title": "Arbalistiek",
    ...
    "advancements.adventure.fall_from_world_height.description": "Overleef een vrije val van de bovenkant van de wereld (bouwlimiet) tot de bodem van de wereld",
    "advancements.adventure.fall_from_world_height.title": "Met je neus op de bodem vallen",
    "advancements.adventure.hero_of_the_village.description": "Verdedig een dorp succesvol tegen een overval",
    ...
    "advancements.adventure.ol_betsy.title": "Ouwe trouwe",
    ...
    "advancements.adventure.play_jukebox_in_meadows.title": "De bergen zingen",
    ...
    "advancements.adventure.spyglass_at_dragon.description": "Kijk door een verrekijker naar de Enderdraak",
    "advancements.adventure.spyglass_at_dragon.title": "Is het een vliegtuig?",
    "advancements.adventure.spyglass_at_ghast.description": "Kijk door een verrekijker naar een Ghast",
    ...
    "advancements.husbandry.axolotl_in_a_bucket.description": "Vang een axolotl in een emmer",
    ...
    "advancements.husbandry.breed_an_animal.title": "De bloempjes en de bijtjes",
    ...
    "advancements.husbandry.kill_axolotl_target.title": "De helende kracht der vriendschap!",
    ...
    "advancements.husbandry.plant_seed.title": "Gras zien groeien",
    "advancements.husbandry.ride_a_boat_with_a_goat.description": "Stap in een boot en dobber met een geit",
    ...
    "advancements.nether.obtain_crying_obsidian.title": "Wie snijdt er uien?",
    ...
    "advancements.nether.ride_strider_in_overworld_lava.description": "Maak een laaaange lavawandeling op een lavarijder in de bovenwereld",
    ...
    "advancements.nether.summon_wither.title": "De vliegende Wither",
    ...
    "advancements.story.obtain_armor.description": "Bescherm jezelf met een stuk ijzeren harnas",
    ...
    "argument.block.property.duplicate": "Eigenschap '%s' mag maar \u00e9\u00e9n keer voorkomen op blok '%s'",
    ...
    "argument.block.property.unknown": "Blok '%s' heeft eigenschap '%s' niet",
    ...
    "argument.entity.invalid": "Ongeldige naam of ongeldig UUID",
    ...
    "argument.entity.options.limit.description": "Maximumaantal entiteiten te retourneren",
    ...
    "argument.entity.options.name.description": "Entiteitsnaam",
    ...
    "argument.entity.options.sort.description": "Entiteiten sorteren",
    ...
    "argument.nbt.array.mixed": "'%s' toevoegen aan '%s' mislukt",
    "argument.nbt.expected.key": "Sleutel verwacht",
    "argument.nbt.expected.value": "Waarde verwacht",
    "argument.nbt.list.mixed": "'%s' toevoegen aan lijst '%s' mislukt",
    ...
    "argument.rotation.incomplete": "Incompleet (twee co\u00f6rdinaten verwacht)",
    ...
    "attribute.name.generic.armor": "harnaspunten",
    ...
    "biome.minecraft.old_growth_pine_taiga": "Oernaaldbomentaiga",
    ...
    "biome.minecraft.snowy_slopes": "Besneeuwde pistes",
    ...
    "biome.minecraft.windswept_forest": "Onstuimig bos",
    "biome.minecraft.windswept_gravelly_hills": "Onstuimige grindheuvels",
    "biome.minecraft.windswept_hills": "Onstuimige heuvels",
    "biome.minecraft.windswept_savanna": "Onstuimige savanne",
    ...
    "block.minecraft.acacia_wall_sign": "Acaciahouten bord aan muur",
    ...
    "block.minecraft.banner.base.black": "Zwart veld",
    "block.minecraft.banner.base.blue": "Blauw veld",
    "block.minecraft.banner.base.brown": "Bruin veld",
    "block.minecraft.banner.base.cyan": "Turquoise veld",
    "block.minecraft.banner.base.gray": "Grijs veld",
    "block.minecraft.banner.base.green": "Groen veld",
    "block.minecraft.banner.base.light_blue": "Lichtblauw veld",
    "block.minecraft.banner.base.light_gray": "Lichtgrijs veld",
    "block.minecraft.banner.base.lime": "Lichtgroen veld",
    "block.minecraft.banner.base.magenta": "Magenta veld",
    "block.minecraft.banner.base.orange": "Oranje veld",
    "block.minecraft.banner.base.pink": "Roze veld",
    "block.minecraft.banner.base.purple": "Paars veld",
    "block.minecraft.banner.base.red": "Rood veld",
    "block.minecraft.banner.base.white": "Wit veld",
    "block.minecraft.banner.base.yellow": "Geel veld",
    ...
    "block.minecraft.banner.border.lime": "Lichtgroene zoom",
    ...
    "block.minecraft.banner.circle.black": "Zwarte koek",
    "block.minecraft.banner.circle.blue": "Blauwe koek",
    "block.minecraft.banner.circle.brown": "Bruine koek",
    "block.minecraft.banner.circle.cyan": "Turquoise koek",
    "block.minecraft.banner.circle.gray": "Grijze koek",
    "block.minecraft.banner.circle.green": "Groene koek",
    "block.minecraft.banner.circle.light_blue": "Lichtblauwe koek",
    "block.minecraft.banner.circle.light_gray": "Lichtgrijze koek",
    "block.minecraft.banner.circle.lime": "Lichtgroene koek",
    "block.minecraft.banner.circle.magenta": "Magenta koek",
    "block.minecraft.banner.circle.orange": "Oranje koek",
    "block.minecraft.banner.circle.pink": "Roze koek",
    "block.minecraft.banner.circle.purple": "Paarse koek",
    "block.minecraft.banner.circle.red": "Rode koek",
    "block.minecraft.banner.circle.white": "Witte koek",
    "block.minecraft.banner.circle.yellow": "Gele koek",
    "block.minecraft.banner.creeper.black": "Zwarte Creeper",
    "block.minecraft.banner.creeper.blue": "Blauwe Creeper",
    "block.minecraft.banner.creeper.brown": "Bruine Creeper",
    "block.minecraft.banner.creeper.cyan": "Turquoise Creeper",
    "block.minecraft.banner.creeper.gray": "Grijze Creeper",
    "block.minecraft.banner.creeper.green": "Groene Creeper",
    "block.minecraft.banner.creeper.light_blue": "Lichtblauwe Creeper",
    "block.minecraft.banner.creeper.light_gray": "Lichtgrijze Creeper",
    "block.minecraft.banner.creeper.lime": "Lichtgroene Creeper",
    "block.minecraft.banner.creeper.magenta": "Magenta Creeper",
    "block.minecraft.banner.creeper.orange": "Oranje Creeper",
    "block.minecraft.banner.creeper.pink": "Roze Creeper",
    "block.minecraft.banner.creeper.purple": "Paarse Creeper",
    "block.minecraft.banner.creeper.red": "Rode Creeper",
    "block.minecraft.banner.creeper.white": "Witte Creeper",
    "block.minecraft.banner.creeper.yellow": "Gele Creeper",
    ...
    "block.minecraft.banner.cross.cyan": "Turquoise andreaskruis",
    ...
    "block.minecraft.banner.curly_border.lime": "Lichtgroene ingesprongen zoom",
    ...
    "block.minecraft.banner.diagonal_left.cyan": "Turquoise schuinlinks verdeeld",
    ...
    "block.minecraft.banner.diagonal_left.lime": "Lichtgroen schuinlinks verdeeld",
    ...
    "block.minecraft.banner.diagonal_right.black": "Zwart schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.blue": "Blauw schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.brown": "Bruin schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.cyan": "Turquoise schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.gray": "Grijs schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.green": "Groen schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.light_blue": "Lichtblauw schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.light_gray": "Lichtgrijs schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.lime": "Lichtgroen schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.magenta": "Magenta schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.orange": "Oranje schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.pink": "Roze schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.purple": "Paars schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.red": "Rood schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.white": "Wit schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_right.yellow": "Geel schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.black": "Zwart omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.blue": "Blauw omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.brown": "Bruin omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.cyan": "Turquoise omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.gray": "Grijs omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.green": "Groen omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.light_blue": "Lichtblauw omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.light_gray": "Lichtgrijs omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.lime": "Lichtgroen omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.magenta": "Magenta omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.orange": "Oranje omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.pink": "Roze omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.purple": "Paars omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.red": "Rood omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.white": "Wit omgekeerd schuinrechts verdeeld",
    "block.minecraft.banner.diagonal_up_left.yellow": "Geel omgekeerd schuinrechts verdeeld",
    ...
    "block.minecraft.banner.diagonal_up_right.cyan": "Turquoise omgekeerd schuinlinks verdeeld",
    ...
    "block.minecraft.banner.diagonal_up_right.lime": "Lichtgroen omgekeerd schuinlinks verdeeld",
    ...
    "block.minecraft.banner.flower.black": "Zwarte bloem",
    "block.minecraft.banner.flower.blue": "Blauwe bloem",
    "block.minecraft.banner.flower.brown": "Bruine bloem",
    "block.minecraft.banner.flower.cyan": "Turquoise bloem",
    "block.minecraft.banner.flower.gray": "Grijze bloem",
    "block.minecraft.banner.flower.green": "Groene bloem",
    "block.minecraft.banner.flower.light_blue": "Lichtblauwe bloem",
    "block.minecraft.banner.flower.light_gray": "Lichtgrijze bloem",
    ...
    "block.minecraft.banner.flower.purple": "Paarse bloem",
    "block.minecraft.banner.flower.red": "Rode bloem",
    ...
    "block.minecraft.banner.gradient_up.black": "Zwart schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.blue": "Blauw schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.brown": "Bruin schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.cyan": "Turquoise schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.gray": "Grijs schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.green": "Groen schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.light_blue": "Lichtblauw schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.light_gray": "Lichtgrijs schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.lime": "Lichtgroen schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.magenta": "Magenta schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.orange": "Oranje schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.pink": "Roze schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.purple": "Paars schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.red": "Rood schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.white": "Wit schildvoetgradi\u00ebnt",
    "block.minecraft.banner.gradient_up.yellow": "Geel schildvoetgradi\u00ebnt",
    ...
    "block.minecraft.banner.half_horizontal.green": "Groengebalkt",
    ...
    "block.minecraft.banner.half_horizontal.purple": "Paarsgebalkt",
    ...
    "block.minecraft.banner.half_horizontal_bottom.cyan": "Turquoise omgekeerd gebalkt",
    "block.minecraft.banner.half_horizontal_bottom.gray": "Grijs omgekeerd gebalkt",
    "block.minecraft.banner.half_horizontal_bottom.green": "Groen omgekeerd gebalkt",
    ...
    "block.minecraft.banner.half_horizontal_bottom.purple": "Paars omgekeerd gebalkt",
    ...
    "block.minecraft.banner.half_vertical.green": "Groengepaald",
    ...
    "block.minecraft.banner.half_vertical.purple": "Paarsgepaald",
    ...
    "block.minecraft.banner.half_vertical_right.gray": "Grijs omgekeerd gepaald",
    "block.minecraft.banner.half_vertical_right.green": "Groen omgekeerd gepaald",
    "block.minecraft.banner.half_vertical_right.light_blue": "Lichtblauw omgekeerd gepaald",
    "block.minecraft.banner.half_vertical_right.light_gray": "Lichtgrijs omgekeerd gepaald",
    "block.minecraft.banner.half_vertical_right.lime": "Lichtgroen omgekeerd gepaald",
    "block.minecraft.banner.half_vertical_right.magenta": "Magenta omgekeerd gepaald",
    "block.minecraft.banner.half_vertical_right.orange": "Oranje omgekeerd gepaald",
    "block.minecraft.banner.half_vertical_right.pink": "Roze omgekeerd gepaald",
    "block.minecraft.banner.half_vertical_right.purple": "Paars omgekeerd gepaald",
    "block.minecraft.banner.half_vertical_right.red": "Rood omgekeerd gepaald",
    "block.minecraft.banner.half_vertical_right.white": "Wit omgekeerd gepaald",
    "block.minecraft.banner.half_vertical_right.yellow": "Geel omgekeerd gepaald",
    "block.minecraft.banner.mojang.black": "Zwart Mojanglogo",
    "block.minecraft.banner.mojang.blue": "Blauw Mojanglogo",
    "block.minecraft.banner.mojang.brown": "Bruin Mojanglogo",
    "block.minecraft.banner.mojang.cyan": "Turquoise Mojanglogo",
    "block.minecraft.banner.mojang.gray": "Grijs Mojanglogo",
    "block.minecraft.banner.mojang.green": "Groen Mojanglogo",
    "block.minecraft.banner.mojang.light_blue": "Lichtblauw Mojanglogo",
    "block.minecraft.banner.mojang.light_gray": "Lichtgrijs Mojanglogo",
    "block.minecraft.banner.mojang.lime": "Lichtgroen Mojanglogo",
    "block.minecraft.banner.mojang.magenta": "Magenta Mojanglogo",
    "block.minecraft.banner.mojang.orange": "Oranje Mojanglogo",
    "block.minecraft.banner.mojang.pink": "Roze Mojanglogo",
    "block.minecraft.banner.mojang.purple": "Paars Mojanglogo",
    "block.minecraft.banner.mojang.red": "Rood Mojanglogo",
    "block.minecraft.banner.mojang.white": "Wit Mojanglogo",
    "block.minecraft.banner.mojang.yellow": "Geel Mojanglogo",
    ...
    "block.minecraft.banner.piglin.cyan": "Turquoise snuit",
    ...
    "block.minecraft.banner.rhombus.black": "Zwart lozanje",
    "block.minecraft.banner.rhombus.blue": "Blauw lozanje",
    "block.minecraft.banner.rhombus.brown": "Bruin lozanje",
    "block.minecraft.banner.rhombus.cyan": "Turquoise lozanje",
    "block.minecraft.banner.rhombus.gray": "Grijs lozanje",
    "block.minecraft.banner.rhombus.green": "Groen lozanje",
    "block.minecraft.banner.rhombus.light_blue": "Lichtblauw lozanje",
    "block.minecraft.banner.rhombus.light_gray": "Lichtgrijs lozanje",
    "block.minecraft.banner.rhombus.lime": "Lichtgroen lozanje",
    "block.minecraft.banner.rhombus.magenta": "Magenta lozanje",
    "block.minecraft.banner.rhombus.orange": "Oranje lozanje",
    "block.minecraft.banner.rhombus.pink": "Roze lozanje",
    "block.minecraft.banner.rhombus.purple": "Paars lozanje",
    "block.minecraft.banner.rhombus.red": "Rood lozanje",
    "block.minecraft.banner.rhombus.white": "Wit lozanje",
    "block.minecraft.banner.rhombus.yellow": "Geel lozanje",
    "block.minecraft.banner.skull.black": "Zwarte schedel",
    "block.minecraft.banner.skull.blue": "Blauwe schedel",
    "block.minecraft.banner.skull.brown": "Bruine schedel",
    "block.minecraft.banner.skull.cyan": "Turquoise schedel",
    "block.minecraft.banner.skull.gray": "Grijze schedel",
    "block.minecraft.banner.skull.green": "Groene schedel",
    "block.minecraft.banner.skull.light_blue": "Lichtblauwe schedel",
    "block.minecraft.banner.skull.light_gray": "Lichtgrijze schedel",
    "block.minecraft.banner.skull.lime": "Lichtgroene schedel",
    "block.minecraft.banner.skull.magenta": "Magenta schedel",
    "block.minecraft.banner.skull.orange": "Oranje schedel",
    "block.minecraft.banner.skull.pink": "Roze schedel",
    "block.minecraft.banner.skull.purple": "Paarse schedel",
    "block.minecraft.banner.skull.red": "Rode schedel",
    "block.minecraft.banner.skull.white": "Witte schedel",
    "block.minecraft.banner.skull.yellow": "Gele schedel",
    ...
    "block.minecraft.banner.small_stripes.cyan": "Turquoise palen",
    ...
    "block.minecraft.banner.small_stripes.lime": "Lichtgroene palen",
    ...
    "block.minecraft.banner.square_bottom_right.cyan": "Turquoise kwartier linksonder",
    ...
    "block.minecraft.banner.square_top_left.cyan": "Turquoise kwartier rechtsboven",
    ...
    "block.minecraft.banner.square_top_left.lime": "Lichtgroen kwartier rechtsboven",
    ...
    "block.minecraft.banner.square_top_right.cyan": "Turquoise kwartier linksboven",
    ...
    "block.minecraft.banner.square_top_right.lime": "Lichtgroen kwartier linksboven",
    ...
    "block.minecraft.banner.straight_cross.cyan": "Turquoise kruis",
    ...
    "block.minecraft.banner.stripe_bottom.black": "Zwart schildvoet",
    "block.minecraft.banner.stripe_bottom.blue": "Blauw schildvoet",
    "block.minecraft.banner.stripe_bottom.brown": "Bruin schildvoet",
    "block.minecraft.banner.stripe_bottom.cyan": "Turquoise schildvoet",
    "block.minecraft.banner.stripe_bottom.gray": "Grijs schildvoet",
    "block.minecraft.banner.stripe_bottom.green": "Groen schildvoet",
    "block.minecraft.banner.stripe_bottom.light_blue": "Lichtblauw schildvoet",
    "block.minecraft.banner.stripe_bottom.light_gray": "Lichtgrijs schildvoet",
    "block.minecraft.banner.stripe_bottom.lime": "Lichtgroen schildvoet",
    "block.minecraft.banner.stripe_bottom.magenta": "Magenta schildvoet",
    "block.minecraft.banner.stripe_bottom.orange": "Oranje schildvoet",
    "block.minecraft.banner.stripe_bottom.pink": "Roze schildvoet",
    "block.minecraft.banner.stripe_bottom.purple": "Paars schildvoet",
    "block.minecraft.banner.stripe_bottom.red": "Rood schildvoet",
    "block.minecraft.banner.stripe_bottom.white": "Wit schildvoet",
    "block.minecraft.banner.stripe_bottom.yellow": "Geel schildvoet",
    ...
    "block.minecraft.banner.stripe_center.cyan": "Turquoise paal",
    ...
    "block.minecraft.banner.stripe_center.lime": "Lichtgroene paal",
    ...
    "block.minecraft.banner.stripe_downleft.cyan": "Turquoise linkerschuinbalk",
    ...
    "block.minecraft.banner.stripe_downright.cyan": "Turquoise rechterschuinbalk",
    ...
    "block.minecraft.banner.stripe_left.cyan": "Turquoise rechterpaal",
    ...
    "block.minecraft.banner.stripe_left.lime": "Lichtgroene rechterpaal",
    ...
    "block.minecraft.banner.stripe_middle.cyan": "Turquoise dwarsbalk",
    "block.minecraft.banner.stripe_middle.gray": "Grijze dwarsbalk",
    "block.minecraft.banner.stripe_middle.green": "Groene dwarsbalk",
    ...
    "block.minecraft.banner.stripe_middle.purple": "Paarse dwarsbalk",
    ...
    "block.minecraft.banner.stripe_right.cyan": "Turquoise linkerpaal",
    ...
    "block.minecraft.banner.stripe_right.lime": "Lichtgroene linkerpaal",
    ...
    "block.minecraft.banner.stripe_top.black": "Zwart schildhoofd",
    "block.minecraft.banner.stripe_top.blue": "Blauw schildhoofd",
    "block.minecraft.banner.stripe_top.brown": "Bruin schildhoofd",
    "block.minecraft.banner.stripe_top.cyan": "Turquoise schildhoofd",
    "block.minecraft.banner.stripe_top.gray": "Grijs schildhoofd",
    "block.minecraft.banner.stripe_top.green": "Groen schildhoofd",
    "block.minecraft.banner.stripe_top.light_blue": "Lichtblauw schildhoofd",
    "block.minecraft.banner.stripe_top.light_gray": "Lichtgrijs schildhoofd",
    "block.minecraft.banner.stripe_top.lime": "Lichtgroen schildhoofd",
    "block.minecraft.banner.stripe_top.magenta": "Magenta schildhoofd",
    "block.minecraft.banner.stripe_top.orange": "Oranje schildhoofd",
    "block.minecraft.banner.stripe_top.pink": "Roze schildhoofd",
    "block.minecraft.banner.stripe_top.purple": "Paars schildhoofd",
    "block.minecraft.banner.stripe_top.red": "Rood schildhoofd",
    "block.minecraft.banner.stripe_top.white": "Wit schildhoofd",
    "block.minecraft.banner.stripe_top.yellow": "Geel schildhoofd",
    ...
    "block.minecraft.banner.triangles_bottom.black": "Zwartgegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.blue": "Blauwgegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.brown": "Bruingegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.cyan": "Turquoisegegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.gray": "Grijsgegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.green": "Groengegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.light_blue": "Lichtblauwgegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.light_gray": "Lichtgrijsgegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.lime": "Lichtgroengegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.magenta": "Magentagegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.orange": "Oranjegegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.pink": "Rozegegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.purple": "Paarsgegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.red": "Roodgegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.white": "Witgegolfd schildvoet",
    "block.minecraft.banner.triangles_bottom.yellow": "Geelgegolfd schildvoet",
    "block.minecraft.banner.triangles_top.black": "Zwartgegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.blue": "Blauwgegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.brown": "Bruingegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.cyan": "Turquoisegegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.gray": "Grijsgegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.green": "Groengegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.light_blue": "Lichtblauwgegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.light_gray": "Lichtgrijsgegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.lime": "Lichtgroengegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.magenta": "Magentagegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.orange": "Oranjegegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.pink": "Rozegegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.purple": "Paarsgegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.red": "Roodgegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.white": "Witgegolfd schildhoofd",
    "block.minecraft.banner.triangles_top.yellow": "Geelgegolfd schildhoofd",
    ...
    "block.minecraft.bed.no_sleep": "Je kunt alleen 's nachts of tijdens onweer slapen",
    "block.minecraft.bed.not_safe": "Je kunt nu niet slapen; er zijn monsters in de buurt",
    "block.minecraft.bed.obstructed": "Dit bed wordt geblokkeerd",
    "block.minecraft.bed.occupied": "Dit bed is bezet",
    "block.minecraft.bed.too_far_away": "Je kunt nu niet slapen; het bed is te ver weg",
    ...
    "block.minecraft.birch_wall_sign": "Berkenhouten bord aan muur",
    ...
    "block.minecraft.cave_air": "Grottenlucht",
    ...
    "block.minecraft.dark_oak_wall_sign": "Donkereikenhouten bord aan muur",
    ...
    "block.minecraft.exposed_cut_copper": "Blootgesteld gesneden koperblok",
    "block.minecraft.exposed_cut_copper_slab": "Blootgestelde gesneden koperen plaat",
    "block.minecraft.exposed_cut_copper_stairs": "Blootgestelde gesneden koperen trap",
    ...
    "block.minecraft.frosted_ice": "Gerijpt ijs",
    ...
    "block.minecraft.jungle_wall_sign": "Oerwoudhouten bord aan muur",
    ...
    "block.minecraft.light_blue_candle_cake": "Taart met lichtblauwe kaars",
    ...
    "block.minecraft.lime_candle": "Lichtgroene kaars",
    "block.minecraft.lime_candle_cake": "Taart met lichtgroene kaars",
    ...
    "block.minecraft.oak_wall_sign": "Eikenhouten bord aan muur",
    ...
    "block.minecraft.potatoes": "Aardappels",
    ...
    "block.minecraft.potted_brown_mushroom": "Opgepotte bruine paddenstoel",
    "block.minecraft.potted_cactus": "Opgepotte cactus",
    "block.minecraft.potted_cornflower": "Opgepotte korenbloem",
    ...
    "block.minecraft.potted_dandelion": "Opgepotte paardenbloem",
    "block.minecraft.potted_dark_oak_sapling": "Opgepotte donkereikenkiemplant",
    "block.minecraft.potted_dead_bush": "Opgepotte dode struik",
    ...
    "block.minecraft.potted_red_mushroom": "Opgepotte rode paddenstoel",
    "block.minecraft.potted_red_tulip": "Opgepotte rode tulp",
    ...
    "block.minecraft.potted_wither_rose": "Opgepotte Witherroos",
    ...
    "block.minecraft.spawn.not_valid": "Je hebt geen bed of opgeladen respawnanker of ze waren geblokkeerd",
    ...
    "block.minecraft.spruce_wall_sign": "Sparrenhouten bord aan muur",
    ...
    "block.minecraft.void_air": "Leegtelucht",
    ...
    "block.minecraft.waxed_exposed_copper": "Ingewassen blootgesteld koperblok",
    "block.minecraft.waxed_exposed_cut_copper": "Ingewassen blootgesteld gesneden koperblok",
    "block.minecraft.waxed_exposed_cut_copper_slab": "Ingewassen blootgestelde gesneden koperen plaat",
    "block.minecraft.waxed_exposed_cut_copper_stairs": "Ingewassen blootgestelde gesneden koperen trap",
    ...
    "block.minecraft.weathered_cut_copper": "Verweerd gesneden koperblok",
    ...
    "chat.cannotSend": "Chatbericht verzenden mislukt",
    ...
    "chat.disabled.profile": "Chat niet toegestaan door accountinstellingen. Kan bericht niet versturen.",
    "chat.editBox": "chat",
    "chat.link.confirm": "Weet je zeker dat je de volgende website wilt openen?",
    "chat.link.confirmTrusted": "Wil je deze link openen of kopi\u00ebren?",
    "chat.link.open": "Openen in browser",
    "chat.link.warning": "Open nooit links van mensen die je niet vertrouwt!",
    "chat.queue": "[+%s regels in de wachtrij]",
    "chat.square_brackets": "[%s]",
    "chat.type.admin": "[%s: %s]",
    "chat.type.advancement.challenge": "%s voltooide uitdaging %s",
    "chat.type.advancement.goal": "%s bereikte doel %s",
    "chat.type.advancement.task": "%s heeft vooruitgang %s behaald",
    "chat.type.announcement": "[%s] %s",
    "chat.type.emote": "* %s %s",
    "chat.type.team.hover": "Bericht sturen naar team",
    ...
    "command.failed": "Er trad een onverwachte fout op tijdens het uitvoeren van deze opdracht",
    ...
    "commands.advancement.advancementNotFound": "Geen vooruitgang gevonden met als naam '%1$s'",
    "commands.advancement.criterionNotFound": "Vooruitgang '%1$s' bevat criterium '%2$s' niet",
    "commands.advancement.grant.criterion.to.many.failure": "Criterium '%s' van vooruitgang '%s' aan %s spelers geven mislukt, omdat ze dit criterium al hebben",
    "commands.advancement.grant.criterion.to.many.success": "Criterium '%s' van vooruitgang '%s' aan %s spelers gegeven",
    "commands.advancement.grant.criterion.to.one.failure": "Criterium '%s' van vooruitgang '%s' aan %s geven mislukt, omdat de speler dit criterium al heeft",
    "commands.advancement.grant.criterion.to.one.success": "Criterium '%s' van vooruitgang '%s' gegeven aan %s",
    "commands.advancement.grant.many.to.many.failure": "%s vooruitgangen geven aan %s spelers mislukt, omdat ze ze al hebben",
    "commands.advancement.grant.many.to.many.success": "%s vooruitgangen gegeven aan %s spelers",
    "commands.advancement.grant.many.to.one.failure": "%s vooruitgangen aan %s geven mislukt, omdat de speler ze al heeft",
    "commands.advancement.grant.many.to.one.success": "%s vooruitgangen gegeven aan %s",
    "commands.advancement.grant.one.to.many.failure": "Vooruitgang '%s' geven aan %s spelers mislukt, omdat ze deze al hebben",
    "commands.advancement.grant.one.to.many.success": "Vooruitgang '%s' gegeven aan %s spelers",
    "commands.advancement.grant.one.to.one.failure": "Vooruitgang '%s' geven aan %s mislukt, omdat de speler deze al heeft",
    ...
    "commands.ban.failed": "Niets gewijzigd, omdat deze speler al geblokkeerd is",
    "commands.ban.success": "%s geblokkeerd: %s",
    "commands.banip.failed": "Niets gewijzigd, omdat dit IP-adres al geblokkeerd is",
    ...
    "commands.banlist.entry": "%s werd geblokkeerd door %s: %s",
    "commands.banlist.list": "%s speler(s) is/zijn geblokkeerd:",
    "commands.banlist.none": "Geen spelers geblokkeerd",
    ...
    "commands.bossbar.set.color.success": "Aangepaste baasbalk '%s' van kleur veranderd",
    "commands.bossbar.set.color.unchanged": "Niets gewijzigd, omdat dit al de kleur van deze baasbalk is",
    "commands.bossbar.set.max.success": "Aangepaste baasbalk '%s' heeft %s als nieuw maximum",
    "commands.bossbar.set.max.unchanged": "Niets gewijzigd, omdat dit al het maximum van deze baasbalk is",
    "commands.bossbar.set.name.success": "Aangepaste baasbalk '%s' hernoemd",
    "commands.bossbar.set.name.unchanged": "Niets gewijzigd, omdat dit al de naam van deze baasbalk is",
    ...
    "commands.bossbar.set.style.unchanged": "Niets gewijzigd, omdat dit al de stijl van deze baasbalk is",
    "commands.bossbar.set.value.success": "Aangepaste baasbalk '%s' heeft %s als nieuwe waarde",
    "commands.bossbar.set.value.unchanged": "Niets gewijzigd, omdat dit al de waarde van deze baasbalk is",
    "commands.bossbar.set.visibility.unchanged.hidden": "Niets gewijzigd, omdat deze baasbalk al verborgen is",
    "commands.bossbar.set.visibility.unchanged.visible": "Niets gewijzigd, omdat deze baasbalk al zichtbaar is",
    "commands.bossbar.set.visible.success.hidden": "Aangepaste baasbalk '%s' verborgen",
    "commands.bossbar.set.visible.success.visible": "Aangepaste baasbalk '%s' zichtbaar gemaakt",
    ...
    "commands.data.merge.failed": "Niets gewijzigd, omdat de gespecificeerde eigenschappen al deze waarden hebben",
    ...
    "commands.debug.function.success.multiple": "%s opdrachten van %s functies opgespoord en geplaatst in bestand %s",
    "commands.debug.function.success.single": "%s opdrachten van functie '%s' opgespoord en geplaatst in bestand %s",
    "commands.debug.function.traceFailed": "Functie opsporen mislukt",
    "commands.debug.notRunning": "Tickprofileerder nog niet gestart",
    ...
    "commands.deop.failed": "Niets gewijzigd, omdat deze speler geen beheerder is",
    "commands.deop.success": "%s is niet langer een serverbeheerder",
    "commands.difficulty.failure": "Niveau werd niet gewijzigd, omdat dit al '%s' is",
    "commands.difficulty.query": "Het niveau is %s",
    "commands.difficulty.success": "Het niveau is ingesteld op %s",
    ...
    "commands.enchant.failed": "Niets gewijzigd, omdat de doelen \u00f3f geen voorwerp in de hand hebben \u00f3f de betovering kan niet worden toegevoegd",
    ...
    "commands.forceload.added.failure": "Er werden geen chunks gemarkeerd als geforceerd geladen",
    ...
    "commands.forceload.added.single": "Chunk %s in dimensie %s gemarkeerd als geforceerd geladen",
    "commands.forceload.list.multiple": "%s geforceerd geladen chunks in dimensie %s werden gevonden op %s",
    "commands.forceload.list.single": "Geforceerd geladen chunk in dimensie %s werd gevonden op %s",
    "commands.forceload.query.failure": "Chunk %s in dimensie %s is niet gemarkeerd als geforceerd geladen",
    "commands.forceload.query.success": "Chunk %s in dimensie %s gemarkeerd als geforceerd geladen",
    "commands.forceload.removed.all": "Alle geforceerd geladen chunks in dimensie %s zijn niet langer aldus gemarkeerd",
    "commands.forceload.removed.failure": "Er werden geen chunks niet langer gemarkeerd voor geforceerd laden",
    ...
    "commands.gamerule.set": "Spelregel %s gewijzigd naar '%s'",
    ...
    "commands.item.source.no_such_slot": "De bron heeft inventarisvak %s niet",
    "commands.item.source.not_a_container": "Bronpositie %s, %s, %s bevat geen inventaris",
    "commands.item.target.no_changed.known_item": "Geen doelen accepteren %s in inventarisvak %s",
    ...
    "commands.locate.failed": "Constructietype '%s' in de buurt vinden mislukt",
    "commands.locate.invalid": "Constructietype '%s' bestaat niet",
    "commands.locate.success": "Dichtstbijzijnde %s bevindt zich op %s (%s blokken afstand)",
    "commands.locatebiome.invalid": "Er is geen klimaat van het soort \"%s\"",
    "commands.locatebiome.notFound": "Vinden van klimaatsoort \"%s\" binnen een redelijke afstand mislukt",
    ...
    "commands.op.failed": "Niets gewijzigd, omdat deze speler al beheerder is",
    "commands.op.success": "%s is nu een serverbeheerder",
    "commands.pardon.failed": "Niets gewijzigd, omdat deze speler niet geblokkeerd is",
    "commands.pardon.success": "%s gedeblokkeerd",
    "commands.pardonip.failed": "Niets gewijzigd, omdat dit IP-adres niet geblokkeerd is",
    ...
    "commands.perf.notRunning": "Prestatieprofileerder nog niet gestart",
    ...
    "commands.placefeature.failed": "Kenmerk plaatsen mislukt",
    "commands.placefeature.invalid": "Kenmerktype '%s' bestaat niet",
    "commands.placefeature.success": "'%s' geplaatst op %s, %s, %s",
    ...
    "commands.publish.success": "Samen spelen wordt gehost op poort %s",
    ...
    "commands.save.enabled": "Automatisch opslaan ingeschakeld",
    "commands.save.failed": "Niet mogelijk om het spel op te slaan (is er genoeg vrije ruimte?)",
    "commands.save.saving": "Spel wordt opgeslagen (dit kan even duren!)",
    "commands.save.success": "Spel opgeslagen",
    ...
    "commands.schedule.same_tick": "Plannen voor huidige tick kan niet",
    ...
    "commands.scoreboard.players.enable.failed": "Niets gewijzigd, omdat de trigger al ingeschakeld is",
    ...
    "commands.scoreboard.players.get.null": "Verkrijgen van waarde van '%s' van %s mislukt, omdat geen gezet is",
    ...
    "commands.scoreboard.players.set.success.single": "%1$s ingesteld op %3$s voor %2$s",
    "commands.seed.success": "Startwaarde: %s",
    "commands.setblock.failed": "Plaatsen van blok mislukt",
    "commands.setblock.success": "Blok op %s, %s, %s gewijzigd",
    "commands.setidletimeout.success": "Maximale tijd die een speler inactief mag zijn op %s minuut/minuten ingesteld",
    "commands.setworldspawn.success": "Wereldspawnpunt ingesteld op %s, %s, %s [%s]",
    ...
    "commands.team.option.collisionRule.unchanged": "Niets gewijzigd, omdat de contactregel al deze waarde heeft",
    ...
    "commands.team.option.deathMessageVisibility.success": "Overlijdensberichtzichtbaarheid van team %s ingesteld op '%s'",
    ...
    "commands.team.option.nametagVisibility.success": "Naamkaartzichtbaarheid van team %s ingesteld op '%s'",
    ...
    "commands.team.remove.success": "Team '%s' verwijderd",
    "commands.teammsg.failed.noteam": "Je moet lid zijn van een team om je team een bericht te sturen",
    ...
    "commands.whitelist.add.failed": "Deze speler staat al op de witte lijst",
    "commands.whitelist.add.success": "%s toegevoegd aan de witte lijst",
    "commands.whitelist.alreadyOff": "Witte lijst is al uitgeschakeld",
    "commands.whitelist.alreadyOn": "Witte lijst is al ingeschakeld",
    "commands.whitelist.disabled": "Witte lijst uitgeschakeld",
    "commands.whitelist.enabled": "Witte lijst ingeschakeld",
    "commands.whitelist.list": "%s speler(s) staat/staan op de witte lijst: %s",
    "commands.whitelist.none": "Er staan geen spelers op de witte lijst",
    "commands.whitelist.reloaded": "Witte lijst herladen",
    "commands.whitelist.remove.failed": "Deze speler staat al niet op de witte lijst",
    "commands.whitelist.remove.success": "%s verwijderd van de witte lijst",
    "commands.worldborder.center.failed": "Niets gewijzigd, omdat de wereldgrens al op dit punt gecentreerd is",
    "commands.worldborder.center.success": "Midden van de wereldgrens ingesteld op %s, %s",
    "commands.worldborder.damage.amount.failed": "Niets gewijzigd, omdat de wereldgrensschadehoeveelheid al die hoeveelheid is",
    "commands.worldborder.damage.amount.success": "Wereldgrensschadehoeveelheid ingesteld op %s per blok per seconde",
    "commands.worldborder.damage.buffer.failed": "Niets gewijzigd, omdat de wereldgrensschadebuffer al deze afstand is",
    ...
    "commands.worldborder.set.failed.nochange": "Niets gewijzigd, omdat de wereldgrens al deze grootte heeft",
    ...
    "commands.worldborder.warning.distance.failed": "Niets gewijzigd, omdat de wereldgrenswaarschuwingsafstand al deze afstand is",
    "commands.worldborder.warning.distance.success": "Wereldgrenswaarschuwingsafstand ingesteld op %s blok(ken)",
    "commands.worldborder.warning.time.failed": "Niets gewijzigd, omdat de wereldgrenswaarschuwingstijd al deze tijd is",
    "commands.worldborder.warning.time.success": "Wereldgrenswaarschuwingstijd ingesteld op %s seconde(n)",
    "compliance.playtime.greaterThan24Hours": "Je speelt al langer dan 24 uur",
    "compliance.playtime.hours": "Je speelt al %s uur",
    ...
    "connect.failed": "Verbinden met server mislukte",
    ...
    "container.enchant.level.requirement": "Niveau %s vereist",
    "container.enderchest": "Enderkist",
    "container.furnace": "Oven",
    "container.grindstone_title": "Repareren en debetoveren",
    ...
    "container.spectatorCantOpen": "Openen mislukt. Inhoud nog niet gegenereerd.",
    ...
    "createWorld.customize.buffet.title": "Buffetwereldaanpassing",
    ...
    "createWorld.customize.custom.biomeDepthWeight": "Gewicht klimaatdiepte",
    ...
    "createWorld.customize.custom.confirm1": "Dit overschrijft je huidige",
    "createWorld.customize.custom.confirm2": "instellingen en kan niet ongedaan worden gemaakt.",
    ...
    "createWorld.customize.custom.dungeonChance": "Kerkeraantal",
    ...
    "createWorld.customize.custom.next": "Volgende",
    ...
    "createWorld.customize.custom.prev": "Vorige",
    ...
    "createWorld.customize.custom.size": "Adergrootte",
    ...
    "createWorld.customize.flat.layer.bottom": "Onderaan - %s",
    "createWorld.customize.flat.layer.top": "Bovenaan - %s",
    ...
    "createWorld.customize.preset.desert": "Woestijn",
    "createWorld.customize.preset.overworld": "Bovenwereld",
    "createWorld.customize.preset.redstone_ready": "Klaar voor Redstone",
    "createWorld.customize.preset.snowy_kingdom": "Besneeuwd koninkrijk",
    "createWorld.customize.preset.the_void": "De leegte",
    "createWorld.customize.preset.tunnelers_dream": "Mijnwerkersdroom",
    "createWorld.customize.preset.water_world": "Waterwereld",
    ...
    "datapackFailure.title": "Door fouten in de momenteel geselecteerde datapakketten kon de wereld niet worden geladen.\nJe kunt proberen de wereld te laden met alleen het standaarddatapakket ('veilige modus') of je kunt teruggaan naar het hoofdmenu en het handmatig oplossen.",
    "death.attack.anvil": "%1$s werd geplet door een vallend aambeeld",
    "death.attack.anvil.player": "%1$s werd geplet door een vallend aambeeld tijdens het vechten tegen %2$s",
    "death.attack.arrow": "%1$s werd doodgeschoten door %2$s",
    "death.attack.arrow.item": "%1$s werd doodgeschoten door %2$s met %3$s",
    "death.attack.badRespawnPoint.link": "intentioneel spelontwerp",
    "death.attack.badRespawnPoint.message": "%1$s werd gedood door %2$s",
    "death.attack.cactus": "%1$s werd doodgeprikt",
    "death.attack.cactus.player": "%1$s liep tegen een cactus om %2$s te ontlopen",
    "death.attack.cramming": "%1$s werd te veel geplet",
    "death.attack.cramming.player": "%1$s werd verpletterd door %2$s",
    ...
    "death.attack.drown": "%1$s verdronk",
    "death.attack.drown.player": "%1$s verdronk om %2$s te ontlopen",
    "death.attack.dryout": "%1$s droogde uit",
    "death.attack.dryout.player": "%1$s droogde uit om %2$s te ontlopen",
    "death.attack.even_more_magic": "%1$s werd gedood door heel veel magie",
    "death.attack.explosion": "%1$s blies op",
    "death.attack.explosion.player": "%1$s werd opgeblazen door %2$s",
    "death.attack.explosion.player.item": "%1$s werd opgeblazen door %2$s met %3$s",
    "death.attack.fall": "%1$s viel te pletter",
    "death.attack.fall.player": "%1$s viel te pletter om %2$s te ontlopen",
    "death.attack.fallingBlock": "%1$s werd geplet door een vallend blok",
    ...
    "death.attack.fireball": "%1$s werd met een vuurbal gedood door %2$s",
    "death.attack.fireball.item": "%1$s werd met een vuurbal gedood door %2$s met %3$s",
    ...
    "death.attack.flyIntoWall.player": "%1$s ervoer kinetische energie om %2$s te ontlopen",
    "death.attack.freeze": "%1$s werd levend bevroren",
    "death.attack.freeze.player": "%1$s werd levend bevroren door %2$s",
    ...
    "death.attack.inFire": "%1$s ging in vlammen op",
    "death.attack.inFire.player": "%1$s liep in een vuur tijdens het vechten tegen %2$s",
    "death.attack.inWall": "%1$s stikte in een muur",
    "death.attack.inWall.player": "%1$s stikte in een muur tijdens het vechten tegen %2$s",
    "death.attack.indirectMagic": "%1$s werd met magie gedood door %2$s",
    "death.attack.indirectMagic.item": "%1$s werd gedood door %2$s met %3$s",
    ...
    "death.attack.lightningBolt": "%1$s werd door bliksem getroffen",
    "death.attack.lightningBolt.player": "%1$s werd door bliksem getroffen tijdens het vechten tegen %2$s",
    "death.attack.magic": "%1$s werd gedood door magie",
    "death.attack.magic.player": "%1$s kwam om door magie om %2$s te ontlopen",
    "death.attack.message_too_long": "Eigenlijk is het bericht te lang om volledig te tonen. Sorry! Hier is de versie zonder opmaak: %s",
    "death.attack.mob": "%1$s werd vermoord door %2$s",
    "death.attack.mob.item": "%1$s werd vermoord door %2$s met %3$s",
    "death.attack.onFire": "%1$s werd levend verbrand",
    "death.attack.onFire.player": "%1$s werd levend verbrand tijdens het vechten tegen %2$s",
    "death.attack.outOfWorld": "%1$s viel uit de wereld",
    "death.attack.outOfWorld.player": "%1$s wilde niet in de wereld van %2$s wonen",
    "death.attack.player": "%1$s werd vermoord door %2$s",
    "death.attack.player.item": "%1$s werd vermoord door %2$s met %3$s",
    "death.attack.stalagmite": "%1$s werd gespietst door een stalagmiet",
    "death.attack.stalagmite.player": "%1$s werd gespietst door een stalagmiet tijdens het vechten tegen %2$s",
    "death.attack.starve": "%1$s verhongerde",
    "death.attack.starve.player": "%1$s verhongerde tijdens het vechten tegen %2$s",
    "death.attack.sting": "%1$s werd doodgestoken",
    ...
    "death.attack.sweetBerryBush.player": "%1$s werd doodgeprikt door een zoetbesstruik om %2$s te ontlopen",
    "death.attack.thorns": "%1$s werd gedood tijdens het aanvallen van %2$s",
    "death.attack.thorns.item": "%1$s werd gedood door %3$s tijdens het aanvallen van %2$s",
    "death.attack.thrown": "%1$s werd toegetakeld door %2$s",
    "death.attack.thrown.item": "%1$s werd toegetakeld door %2$s met %3$s",
    "death.attack.trident": "%1$s werd gespietst door %2$s",
    "death.attack.trident.item": "%1$s werd gespietst door %2$s met %3$s",
    "death.attack.wither": "%1$s verschrompelde",
    ...
    "death.fell.accident.generic": "%1$s viel van een hoge plek",
    "death.fell.accident.ladder": "%1$s viel van een ladder",
    ...
    "death.fell.accident.vines": "%1$s viel uit lianen",
    "death.fell.accident.weeping_vines": "%1$s viel uit een hangende klimop",
    "death.fell.assist": "%1$s werd gedoemd te vallen door %2$s",
    "death.fell.assist.item": "%1$s werd gedoemd te vallen door %2$s met %3$s",
    "death.fell.finish": "%1$s viel te ver en werd afgemaakt door %2$s",
    "death.fell.finish.item": "%1$s viel te ver en werd afgemaakt door %2$s met %3$s",
    ...
    "debug.advanced_tooltips.help": "F3 + H = Geavanceerde tekstballonnen",
    "debug.advanced_tooltips.off": "Geavanceerde tekstballonnen: verborgen",
    "debug.advanced_tooltips.on": "Geavanceerde tekstballonnen: zichtbaar",
    "debug.chunk_boundaries.help": "F3 + G = Chunkgrenzen tonen",
    "debug.chunk_boundaries.off": "Chunkgrenzen: verborgen",
    "debug.chunk_boundaries.on": "Chunkgrenzen: zichtbaar",
    ...
    "debug.copy_location.message": "Locatie gekopieerd",
    ...
    "debug.creative_spectator.help": "F3 + N = Tussen vorige modus en toeschouwermodus wisselen",
    "debug.cycle_renderdistance.help": "F3 + F = Weergavebereik aanpassen (druk op shift om terug te gaan)",
    ...
    "debug.help.help": "F3 + Q = Deze lijst tonen",
    ...
    "debug.inspect.help": "F3 + I = Entiteits- of blokdata kopi\u00ebren",
    ...
    "debug.show_hitboxes.on": "Contactvelden: zichtbaar",
    "demo.day.1": "Deze demo duurt vijf speldagen, doe je best!",
    "demo.day.2": "Dag twee",
    "demo.day.3": "Dag drie",
    "demo.day.4": "Dag vier",
    "demo.day.5": "Dit is je laatste dag!",
    "demo.day.6": "Je vijfde dag is voorbij. Gebruik %s om een schermafbeelding van je creatie te maken.",
    ...
    "difficulty.lock.question": "Weet je zeker dat je het niveau van deze wereld wilt vergrendelen? Dit zal de wereld vergrendelen op %1$s en je kunt dit later niet meer wijzigen.",
    ...
    "disconnect.exceeded_packet_rate": "Uit de server gezet voor het overschrijden van de datalimiet",
    "disconnect.genericReason": "%s",
    "disconnect.kicked": "werd uit het spel gezet",
    "disconnect.loginFailed": "Aanmelden mislukt",
    "disconnect.loginFailedInfo": "Aanmelden mislukt: %s",
    "disconnect.loginFailedInfo.insufficientPrivileges": "Samen spelen is uitgeschakeld. Controleer je Microsoftaccountinstellingen.",
    ...
    "disconnect.timeout": "Geen antwoord",
    ...
    "effect.minecraft.conduit_power": "Zegen van de zee",
    ...
    "effect.minecraft.hero_of_the_village": "Held der dorpelingen",
    ...
    "effect.minecraft.jump_boost": "Sprongversterking",
    ...
    "effect.minecraft.weakness": "Zwakheid",
    ...
    "enchantment.minecraft.luck_of_the_sea": "Geluk der zee\u00ebn",
    ...
    "entity.minecraft.area_effect_cloud": "Gebiedseffectwolk",
    ...
    "entity.minecraft.leash_knot": "Leidtouwknoop",
    ...
    "entity.minecraft.tnt": "Aangestoken TNT",
    ...
    "entity.minecraft.tropical_fish.predefined.14": "Rode cichlide",
    ...
    "entity.minecraft.tropical_fish.predefined.20": "Geelstaartpapegaaivis",
    ...
    "entity.minecraft.villager.mason": "Steenhouwer",
    ...
    "entity.minecraft.wandering_trader": "Rondreizende handelaar",
    ...
    "entity.notFound": "Entiteit '%s' is onbekend",
    ...
    "filled_map.buried_treasure": "Schatkaart",
    "filled_map.id": "Nr. %s",
    ...
    "gameMode.changed": "Jouw spelmodus werd gewijzigd naar %s",
    ...
    "gamerule.disableElytraMovementCheck": "Dekschildbewegingscontrole uitvoeren",
    ...
    "gamerule.doInsomnia": "Fantomen spawnen",
    ...
    "gamerule.forgiveDeadPlayers": "Dode spelers vergeven",
    ...
    "gamerule.freezeDamage": "Vorstschade toedienen",
    "gamerule.keepInventory": "Inventaris behouden na dood",
    ...
    "gamerule.reducedDebugInfo.description": "Inhoud van het debugscherm beperken",
    ...
    "generator.amplified.info": "Let op: gewoon voor de lol! Vereist een krachtige computer.",
    ...
    "gui.narrate.slider": "%s: schuifregelaar",
    "gui.no": "Nee",
    "gui.none": "Geen",
    "gui.ok": "Ok\u00e9",
    ...
    "gui.socialInteractions.empty_blocked": "Geen geblokkeerde spelers in chat",
    ...
    "gui.socialInteractions.hide": "Verbergen in chat",
    ...
    "gui.socialInteractions.show": "Tonen in chat",
    ...
    "item.canBreak": "Breekt:",
    "item.canPlace": "Plaatsbaar op:",
    "item.color": "Kleur: %s",
    ...
    "item.minecraft.creeper_banner_pattern": "Banierpatroon",
    ...
    "item.minecraft.diamond_chestplate": "Diamanten kuras",
    ...
    "item.minecraft.diamond_shovel": "Diamanten schep",
    ...
    "item.minecraft.firework_star.lime": "Lichtgroen",
    ...
    "item.minecraft.golden_chestplate": "Gouden kuras",
    ...
    "item.minecraft.golden_shovel": "Gouden schep",
    ...
    "item.minecraft.iron_chestplate": "IJzeren kuras",
    ...
    "item.minecraft.iron_shovel": "IJzeren schep",
    ...
    "item.minecraft.stone_shovel": "Stenen schep",
    ...
    "item.minecraft.wooden_shovel": "Houten schep",
    ...
    "key.drop": "Geselecteerde voorwerp laten vallen",
    ...
    "key.keyboard.left.control": "Linkerctrl",
    ...
    "key.keyboard.right.control": "Rechterctrl",
    ...
    "key.mouse": "Knop %1$s",
    "key.mouse.left": "Linksklikken",
    "key.mouse.middle": "Muiswiel",
    "key.mouse.right": "Rechtsklikken",
    ...
    "menu.shareToLan": "Openen voor LAN",
    "menu.singleplayer": "Alleen spelen",
    "menu.working": "Bezig...",
    "merchant.current_level": "Huidig niveau handelaar",
    "merchant.deprecated": "Dorpelingen vullen hun voorraad tot twee keer per dag aan.",
    "merchant.level.1": "Beginner",
    "merchant.level.2": "Leerling",
    "merchant.level.3": "Gezel",
    "merchant.level.4": "Deskundige",
    "merchant.level.5": "Meester",
    "merchant.next_level": "Volgend niveau handelaar",
    ...
    "multiplayer.disconnect.banned": "Je bent geblokkeerd op deze server",
    "multiplayer.disconnect.banned.expiration": "\nDe blokkade verloopt op %s",
    "multiplayer.disconnect.banned.reason": "Je bent geblokkeerd op deze server. Reden: %s",
    "multiplayer.disconnect.banned_ip.expiration": "\nDe blokkade verloopt op %s",
    "multiplayer.disconnect.banned_ip.reason": "Jouw IP-adres is geblokkeerd op deze server. Reden: %s",
    "multiplayer.disconnect.duplicate_login": "Je meldde je aan vanaf een andere locatie",
    ...
    "multiplayer.disconnect.invalid_entity_attacked": "Er werd geprobeerd een ongeldig entiteit aan te vallen",
    ...
    "multiplayer.disconnect.invalid_player_movement": "Ongeldige data voor bewegende speler ontvangen",
    "multiplayer.disconnect.invalid_vehicle_movement": "Ongeldige data voor bewegend voertuig ontvangen",
    "multiplayer.disconnect.ip_banned": "Jouw IP-adres is geblokkeerd op deze server",
    ...
    "multiplayer.disconnect.name_taken": "Deze naam wordt al gebruikt",
    "multiplayer.disconnect.not_whitelisted": "Je staat niet op de witte lijst van deze server!",
    ...
    "multiplayer.disconnect.server_full": "De server is vol!",
    "multiplayer.disconnect.server_shutdown": "Server werd gesloten",
    ...
    "multiplayer.disconnect.unverified_username": "Het verifi\u00ebren van de gebruikersnaam mislukte!",
    "multiplayer.downloadingStats": "Statistieken ophalen...",
    "multiplayer.downloadingTerrain": "Terrein laden...",
    "multiplayer.message_not_delivered": "Chatbericht kon niet worden ontvangen; controleer de serverlogboeken: %s",
    "multiplayer.player.joined": "%s kwam het spel binnen",
    "multiplayer.player.joined.renamed": "%s (voorheen bekend als %s) kwam het spel binnen",
    "multiplayer.player.left": "%s verliet het spel",
    ...
    "multiplayer.socialInteractions.not_available": "Sociale interacties zijn alleen beschikbaar in werelden waar je samen speelt",
    "multiplayer.status.and_more": "...en nog %s andere speler(s)...",
    "multiplayer.status.cancelled": "Geannuleerd",
    "multiplayer.status.cannot_connect": "Verbinding maken met de server mislukt",
    "multiplayer.status.cannot_resolve": "Omzetten van hostnaam mislukt",
    ...
    "multiplayer.status.request_handled": "Statusaanvraag werd behandeld",
    ...
    "narration.checkbox.usage.focused": "Druk op Enter om te wisselen",
    "narration.checkbox.usage.hovered": "Klik op de linkermuisknop om te wisselen",
    ...
    "narration.cycle_button.usage.hovered": "Klik op de linkermuisknop om over te schakelen naar %s",
    "narration.edit_box": "Bewerkingsvak: %s",
    "narration.recipe": "Recept voor %s",
    "narration.recipe.usage": "Klik op de linkermuisknop om te selecteren",
    "narration.recipe.usage.more": "Klik op de rechtermuisknop om meer recepten te tonen",
    "narration.selection.usage": "Gebruik pijltjestoetsen omhoog en omlaag om een ander item te selecteren",
    "narration.slider.usage.focused": "Gebruik pijltjestoetsen links en rechts om waarde te wijzigen",
    ...
    "narrator.button.difficulty_lock": "Niveauvergrendeling",
    ...
    "narrator.controls.bound": "%s is gebonden aan %s",
    "narrator.controls.reset": "%s-knop resetten",
    "narrator.controls.unbound": "%s is niet gebonden",
    "narrator.joining": "Betreden",
    "narrator.loading": "%s aan het laden",
    "narrator.loading.done": "Gereed",
    "narrator.position.list": "Rij %s van %s geselecteerd",
    ...
    "options.allowServerListing.tooltip": "Servers kunnen online spelers tonen als onderdeel van hun publieke status.\nDoor deze instelling uit te zetten, wordt jouw naam niet in deze lijsten getoond.",
    "options.ao": "Zachte belichting",
    "options.ao.max": "maximum",
    "options.ao.min": "minimum",
    "options.ao.off": "UIT",
    "options.attack.crosshair": "vizier",
    "options.attack.hotbar": "werkbalk",
    ...
    "options.chat.scale": "Chattekstgrootte",
    ...
    "options.entityShadows": "Entiteitsschaduwen",
    ...
    "options.fovEffectScale.tooltip": "Bepaalt hoeveel het gezichtsveld kan wijzigen met snelheidseffecten.",
    ...
    "options.graphics.warning.message": "Er werd gedetecteerd dat je grafische apparaat de grafische instelling \"%s\" niet ondersteunt.\n\nJe mag dit negeren en doorgaan, maar er wordt geen ondersteuning aangeboden voor jouw apparaat als je de grafische instelling \"%s\" gebruikt.",
    ...
    "options.hideLightningFlashes": "Bliksemflitsen verbergen",
    ...
    "options.modelPart.left_pants_leg": "Linkerbroekspijp",
    "options.modelPart.left_sleeve": "Linkermouw",
    "options.modelPart.right_pants_leg": "Rechterbroekspijp",
    ...
    "options.online": "Online-instellingen",
    ...
    "options.prioritizeChunkUpdates.byPlayer.tooltip": "Chunks worden onmiddellijk opnieuw opgebouwd bij bepaalde acties zoals het plaatsen en vernietigen van blokken.",
    "options.prioritizeChunkUpdates.nearby": "asynchroon",
    "options.prioritizeChunkUpdates.nearby.tooltip": "Nabije chunks worden altijd onmiddellijk opgebouwd. Spelprestaties kunnen verslechteren bij het plaatsen en vernietigen van blokken.",
    "options.prioritizeChunkUpdates.none": "synchroon",
    "options.prioritizeChunkUpdates.none.tooltip": "Nabije chunks worden parallel opgebouwd. Er kunnen kort gaten worden weergegeven bij het vernietigen van blokken.",
    "options.rawMouseInput": "Onbewerkte invoer",
    "options.realmsNotifications": "Realmsmeldingen",
    "options.reducedDebugInfo": "Minder debuginformatie",
    ...
    "options.showSubtitles": "Ondertiteling",
    ...
    "options.sounds": "Muziek en geluiden",
    "options.sounds.title": "Muziek- en geluidinstellingen",
    ...
    "pack.dropConfirm": "Wil je de volgende pakketten toevoegen aan Minecraft?",
    ...
    "pack.incompatible.confirm.title": "Weet je zeker dat je dit pakket wilt laden?",
    ...
    "realms.missing.snapshot.error.text": "Realms wordt in snapshots niet ondersteund",
    ...
    "resourcePack.server.name": "Wereld-specifieke hulpbronnen",
    "resourcePack.title": "Bronpakketten selecteren",
    "resourcePack.vanilla.description": "Het standaardbronpakket van Minecraft",
    ...
    "screenshot.failure": "Schermafbeelding opslaan mislukt: %s",
    ...
    "selectWorld.allowCommands": "Cheats",
    ...
    "selectWorld.backupQuestion.experimental": "Werelden met experimentele instellingen worden niet ondersteund",
    "selectWorld.backupQuestion.snapshot": "Wil je deze wereld echt laden?",
    "selectWorld.backupWarning.customized": "We ondersteunen aangepaste werelden niet in deze versie van Minecraft. De wereld kan nog steeds geladen worden en alles houden zoals het was, maar nieuw terrein is niet langer aangepast. Het spijt ons voor het ongemak!",
    "selectWorld.backupWarning.downgrade": "Deze wereld werd voor het laatst gespeeld in %s; je bent in versie %s. Downgraden kan een wereld beschadigen - we kunnen niet garanderen dat het zal laden of werken. Als je nog steeds door wilt gaan, maak dan een back-up!",
    ...
    "selectWorld.backupWarning.snapshot": "Deze wereld werd voor het laatst gespeeld in %s; je gebruikt %s. Maak een back-up voor het geval je wereld beschadigingen oploopt!",
    "selectWorld.bonusItems": "Bonuskist",
    "selectWorld.cheats": "Cheats",
    "selectWorld.conversion": "Moet worden omgezet!",
    "selectWorld.conversion.tooltip": "Deze wereld moet worden geopend in een oudere versie (zoals 1.6.4) om veilig te worden omgezet",
    ...
    "selectWorld.deleteWarning": "'%s' zal voor eeuwig verloren gaan (en dat is lang)!",
    ...
    "selectWorld.edit.backupFolder": "Back-upmap openen",
    "selectWorld.edit.backupSize": "grootte: %sMB",
    "selectWorld.edit.export_worldgen_settings": "Generatorinstellingen exporteren",
    ...
    "selectWorld.edit.openFolder": "Map openen",
    ...
    "selectWorld.futureworld.error.text": "Iets ging verkeerd tijdens het laden van een wereld die voor het laatst geopend werd in een toekomstige versie. Dit was, om te beginnen, al risicovol. Het spijt ons dat het niet werkte.",
    ...
    "selectWorld.gameMode.adventure.line2": "geplaatst of gebroken worden",
    ...
    "selectWorld.gameMode.spectator.line1": "Je kan kijken, maar niet aanraken",
    ...
    "selectWorld.import_worldgen_settings": "Instellingen importeren",
    "selectWorld.import_worldgen_settings.deprecated.question": "Sommige gebruikte functies zijn verouderd en zullen in de toekomst stoppen met functioneren. Wil je doorgaan?",
    "selectWorld.import_worldgen_settings.deprecated.title": "Waarschuwing! Deze instellingen gebruiken verouderde functies",
    "selectWorld.import_worldgen_settings.experimental.question": "Deze instellingen zijn experimenteel en kunnen op een gegeven moment stoppen met functioneren. Wil je doorgaan?",
    "selectWorld.import_worldgen_settings.experimental.title": "Waarschuwing! Deze instellingen gebruiken experimentele functies",
    "selectWorld.import_worldgen_settings.failure": "Instellingen importeren mislukt",
    "selectWorld.import_worldgen_settings.select_file": "Instellingenbestand kiezen (.json)",
    ...
    "selectWorld.mapFeatures": "Constructies",
    ...
    "selectWorld.recreate.customized.text": "Aangepaste werelden worden niet langer ondersteund in deze versie van Minecraft. We kunnen proberen de wereld opnieuw te cre\u00ebren met dezelfde startwaarde en eigenschappen, maar terreinaanpassingen gaan verloren. Het spijt ons voor het ongemak!",
    "selectWorld.recreate.customized.title": "Aangepaste werelden worden niet langer ondersteund",
    "selectWorld.recreate.error.text": "Iets ging verkeerd bij het hercre\u00ebren van een wereld.",
    "selectWorld.recreate.error.title": "Er trad een fout op!",
    "selectWorld.resultFolder": "Wordt opgeslagen in:",
    "selectWorld.search": "zoeken naar werelden",
    "selectWorld.seedInfo": "Laat leeg voor een willekeurige startwaarde",
    "selectWorld.select": "Wereld spelen",
    "selectWorld.title": "Wereld selecteren",
    "selectWorld.tooltip.fromNewerVersion1": "Deze wereld werd opgeslagen in een nieuwere versie.",
    "selectWorld.tooltip.fromNewerVersion2": "Het laden van de wereld in deze versie kan problemen veroorzaken!",
    "selectWorld.tooltip.snapshot1": "Vergeet niet een back-up te maken van deze wereld",
    "selectWorld.tooltip.snapshot2": "voordat je het gaat laden in deze snapshot.",
    "selectWorld.unable_to_load": "Werelden laden mislukt",
    ...
    "selectWorld.versionWarning": "Deze wereld werd voor het laatst gespeeld in %s. Het laden van de wereld in deze versie kan beschadigingen veroorzaken!",
    "selectWorld.world": "Wereld",
    "sign.edit": "Bordtekst bewerken",
    "sleep.not_possible": "Deze nacht kan niet worden overgeslagen",
    ...
    "soundCategory.record": "Platenspeler/nootblokken",
    ...
    "spectatorMenu.root.prompt": "Druk op een knop om een opdracht te selecteren en nogmaals om die te gebruiken.",
    "spectatorMenu.team_teleport": "Naar teamlid teleporteren",
    "spectatorMenu.team_teleport.prompt": "Selecteer een team om naar te teleporteren",
    "spectatorMenu.teleport": "Naar speler teleporteren",
    ...
    "stat.minecraft.aviate_one_cm": "Afstand per dekschild",
    ...
    "stat.minecraft.damage_dealt": "Schade toegediend",
    ...
    "stat.minecraft.drop": "Voorwerpen laten vallen",
    ...
    "stat.minecraft.horse_one_cm": "Afstand te paard",
    ...
    "stat.minecraft.interact_with_smithing_table": "Interacties met smeedstafel",
    "stat.minecraft.interact_with_smoker": "Interacties met roker",
    "stat.minecraft.interact_with_stonecutter": "Interacties met steenzaag",
    ...
    "stat.minecraft.sleep_in_bed": "Keren in bed geslapen",
    ...
    "stat_type.minecraft.dropped": "Laten vallen",
    "stat_type.minecraft.killed": "Je hebt %s %s gedood",
    "stat_type.minecraft.killed.none": "Je hebt %s nooit gedood",
    "stat_type.minecraft.killed_by": "%s heeft jou %s keer gedood",
    "stat_type.minecraft.killed_by.none": "Je bent nooit gedood door %s",
    ...
    "structure_block.button.detect_size": "ZOEKEN",
    ...
    "structure_block.detect_size": "Grootte en positie zoeken:",
    ...
    "structure_block.integrity": "Constructie-integriteit en startwaarde",
    "structure_block.integrity.integrity": "Constructie-integriteit",
    "structure_block.integrity.seed": "Constructiestartwaarde",
    "structure_block.invalid_structure_name": "Constructienaam '%s' is ongeldig",
    "structure_block.load_not_found": "Constructie '%s' is niet beschikbaar",
    "structure_block.load_prepare": "Positie voor constructie '%s' voorbereid",
    "structure_block.load_success": "Constructie geladen uit '%s'",
    ...
    "structure_block.save_failure": "Constructie '%s' opslaan mislukt",
    "structure_block.save_success": "Constructie opgeslagen als '%s'",
    "structure_block.show_air": "Onzichtbare blokken tonen:",
    "structure_block.show_boundingbox": "Begrenzing tonen:",
    "structure_block.size": "Constructiegrootte",
    "structure_block.size.x": "constructiegrootte x",
    "structure_block.size.y": "constructiegrootte y",
    "structure_block.size.z": "constructiegrootte z",
    "structure_block.size_failure": "Constructiegrootte bepalen mislukt. Voeg hoeken met overeenkomende constructienamen toe.",
    "structure_block.size_success": "Grootte succesvol gevonden voor '%s'",
    ...
    "subtitles.block.anvil.destroy": "Aambeeld wordt vernietigd",
    "subtitles.block.anvil.land": "Aambeeld landt",
    "subtitles.block.anvil.use": "Aambeeld wordt gebruikt",
    ...
    "subtitles.block.big_dripleaf.tilt_down": "Druipblad kantelt omlaag",
    "subtitles.block.big_dripleaf.tilt_up": "Druipblad kantelt omhoog",
    ...
    "subtitles.block.chest.locked": "Kist vergrendelt",
    ...
    "subtitles.block.composter.empty": "Compostbak leegt",
    "subtitles.block.composter.fill": "Compostbak vult",
    ...
    "subtitles.block.dispenser.dispense": "Voorwerp wordt weggeschoten",
    ...
    "subtitles.block.growing_plant.crop": "Plant wordt gesnoeid",
    ...
    "subtitles.block.respawn_anchor.charge": "Respawnanker wordt opgeladen",
    "subtitles.block.respawn_anchor.deplete": "Respawnanker wordt gebruikt",
    "subtitles.block.respawn_anchor.set_spawn": "Respawnanker stelt spawnpunt in",
    "subtitles.block.sculk_sensor.clicking": "Sculksensor begint te klikken",
    "subtitles.block.sculk_sensor.clicking_stop": "Sculksensor stopt te klikken",
    "subtitles.block.shulker_box.close": "Shulkerdoos sluit",
    "subtitles.block.shulker_box.open": "Shulkerdoos opent",
    "subtitles.block.smithing_table.use": "Smeedstafel wordt gebruikt",
    ...
    "subtitles.entity.arrow.hit_player": "Speler wordt geraakt",
    ...
    "subtitles.entity.axolotl.hurt": "Axolotl raakt gewond",
    ...
    "subtitles.entity.dolphin.death": "Dolfijn sterft",
    "subtitles.entity.dolphin.eat": "Dolfijn eet",
    "subtitles.entity.dolphin.hurt": "Dolfijn raakt gewond",
    ...
    "subtitles.entity.drowned.hurt": "Drenkeling raakt gewond",
    ...
    "subtitles.entity.elder_guardian.hurt": "Oude bewaker raakt gewond",
    ...
    "subtitles.entity.evoker.cast_spell": "Oproeper spreekt vloek uit",
    ...
    "subtitles.entity.fishing_bobber.throw": "Dobber wordt gegooid",
    ...
    "subtitles.entity.fox.hurt": "Vos raakt gewond",
    "subtitles.entity.fox.screech": "Vos piept",
    "subtitles.entity.fox.sleep": "Vos slaapt",
    ...
    "subtitles.entity.goat.hurt": "Geit raakt gewond",
    ...
    "subtitles.entity.hoglin.hurt": "Hoglin raakt gewond",
    "subtitles.entity.hoglin.retreat": "Hoglin vlucht",
    "subtitles.entity.hoglin.step": "Hoglin loopt",
    ...
    "subtitles.entity.horse.hurt": "Paard raakt gewond",
    ...
    "subtitles.entity.iron_golem.hurt": "IJzergolem raakt gewond",
    "subtitles.entity.iron_golem.repair": "IJzergolem wordt gerepareerd",
    ...
    "subtitles.entity.leash_knot.place": "Leidtouwknoop wordt vastgebonden",
    ...
    "subtitles.entity.magma_cube.hurt": "Magmakubus raakt gewond",
    ...
    "subtitles.entity.mule.ambient": "Muilezel balkt",
    ...
    "subtitles.entity.panda.hurt": "Panda raakt gewond",
    ...
    "subtitles.entity.parrot.hurts": "Papegaai raakt gewond",
    ...
    "subtitles.entity.parrot.imitate.piglin_brute": "Papegaai knort machtig",
    ...
    "subtitles.entity.phantom.hurt": "Fantoom raakt gewond",
    ...
    "subtitles.entity.pig.hurt": "Varken raakt gewond",
    ...
    "subtitles.entity.piglin.hurt": "Piglin raakt gewond",
    "subtitles.entity.piglin.jealous": "Piglin knort jaloers",
    "subtitles.entity.piglin.retreat": "Piglin vlucht",
    "subtitles.entity.piglin.step": "Piglin loopt",
    "subtitles.entity.piglin_brute.ambient": "Piglinbruut knort",
    "subtitles.entity.piglin_brute.angry": "Piglinbruut knort boos",
    ...
    "subtitles.entity.piglin_brute.hurt": "Piglinbruut raakt gewond",
    ...
    "subtitles.entity.pillager.hurt": "Rover raakt gewond",
    ...
    "subtitles.entity.player.levelup": "Speler gaat niveau omhoog",
    "subtitles.entity.polar_bear.ambient": "IJsbeer gromt",
    ...
    "subtitles.entity.puffer_fish.death": "Kogelvis sterft",
    "subtitles.entity.puffer_fish.flop": "Kogelvis flopt",
    "subtitles.entity.puffer_fish.hurt": "Kogelvis raakt gewond",
    ...
    "subtitles.entity.rabbit.hurt": "Konijn raakt gewond",
    ...
    "subtitles.entity.ravager.hurt": "Verwoester raakt gewond",
    "subtitles.entity.ravager.roar": "Verwoester brult",
    "subtitles.entity.ravager.step": "Verwoester loopt",
    "subtitles.entity.ravager.stunned": "Verwoester wordt verdooft",
    "subtitles.entity.salmon.death": "Zalm sterft",
    "subtitles.entity.salmon.flop": "Zalm flopt",
    "subtitles.entity.salmon.hurt": "Zalm raakt gewond",
    "subtitles.entity.sheep.ambient": "Schaap blaat",
    "subtitles.entity.sheep.death": "Schaap sterft",
    "subtitles.entity.sheep.hurt": "Schaap raakt gewond",
    ...
    "subtitles.entity.shulker.hurt": "Shulker raakt gewond",
    ...
    "subtitles.entity.skeleton_horse.hurt": "Skeletpaard raakt gewond",
    ...
    "subtitles.entity.squid.squirt": "Inktvis spuit inkt",
    ...
    "subtitles.entity.strider.hurt": "Lavarijder raakt gewond",
    ...
    "subtitles.entity.tropical_fish.hurt": "Tropische vis raakt gewond",
    ...
    "subtitles.entity.turtle.hurt": "Schildpad raakt gewond",
    "subtitles.entity.turtle.hurt_baby": "Schildpadbaby raakt gewond",
    ...
    "subtitles.entity.villager.work_leatherworker": "Leerlooier werkt",
    ...
    "subtitles.entity.wandering_trader.hurt": "Rondreizende handelaar raakt gewond",
    ...
    "subtitles.entity.zoglin.hurt": "Zoglin raakt gewond",
    "subtitles.entity.zoglin.step": "Zoglin loopt",
    ...
    "subtitles.entity.zombie_horse.hurt": "Zombiepaard raakt gewond",
    ...
    "subtitles.entity.zombified_piglin.hurt": "Zombiepiglin raakt gewond",
    ...
    "subtitles.item.dye.use": "Kleurstof verft",
    "subtitles.item.firecharge.use": "Vuurbal suist",
    "subtitles.item.flintandsteel.use": "Vuursteen en staal klikt",
    "subtitles.item.glow_ink_sac.use": "Gloeiende inktzak smeert",
    ...
    "subtitles.item.ink_sac.use": "Inktzak smeert",
    ...
    "subtitles.item.shovel.flatten": "Schep plet",
    ...
    "team.collision.pushOtherTeams": "Andere teams duwen",
    "team.collision.pushOwnTeam": "Eigen team duwen",
    ...
    "title.32bit.deprecation.realms": "Binnenkort vereist Minecraft een 64-bitssysteem, waardoor je niet meer kunt spelen of Realms gebruiken op dit apparaat. Realmsabonnementen moeten handmatig geannuleerd worden.",
    ...
    "title.multiplayer.other": "Samen spelen (server van derde partij)",
